...
label ch15_exclusive_monika:
    ...
    if monika_type == 0 or (monika_type == 1 and ch12_markov_agree):
        ...
        if monika_type == 0:
            ...
            m "I really don't know what to do with these feelings."
            "Monika smiles bashfully."
            m "I've never felt this way before."
            m "I've never needed these feelings."
            m "I always thought love was some useless emotion."
            m "But now..."
            m "These feelings...they tear into my heart."
            m "There's this rush of adrenaline every time you're near me."
            m "And when you talk to me I just can't contain myself."
            m "I hope this feeling lasts."
            m "It's not long now until we'll have each other, forever."
            m "So go, we'll see each other tomorrow."
            m "In much better conditions, I promise."
    else:
        m "I don't have time for this."
        m "I need you to be properly indoctrinated when I start tomororw."
        m "I can tell you've almost finished the book."
        m "You've almost finished that book."
        m "You know, it used to be in a completely different language."
        m "I translated it myself once I learned how to speak this language."
        m "There used to be {i}so{/i} many more copies of it."
        m "Before all of this."
        m "People became wise and..."
        m "Never mind."
        m "Just go home and go finish reading that book."
    ...
    if monika_type == 0:
        ...
        "Her supernatural abilties allow her to manipulate people."
...
label ch15_mall_shared:
    ...
    n "'Cause you know...it's not really something people a lot of people care about."
    ...
    n "And then..."
    n "[player] came."
    n "I don't know why but after [player_personal], I feel like that's when the club started."
