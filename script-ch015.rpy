...
label ch15_exclusive_yuri:
    ...
    y "Oh...nothing."
    y "I just kinda wanted to finish seeing the sunset."
    ...
    y "So it would be wrong if I didn't see this through."
    mc "Some partner I am."
    mc "You've done a lot more work than me."
    y "I don't mind."
    y "At least you care enough about this."
    y "Otherwise you wouldn't have invited me here to help, right?"
    mc "Yeah..."
    if yuri_date:
        y "So you've met her twice now, so..."
    else:
        y "You don't have to tell me but..."
    ...
    y "It's strange because I was going to say the same thing."
    ...
    y "Maybe...but somehow I doubt it."
    "Yuri goes back to doing the preparations."
    y "I don't know why but I'm exceedingly excited for tomorrow."
    mc "I wouldn't say I feel the same but I'm definitely kinda excited."
    mc "Though there's also this feeling of anxiety."
    y "It will go away when we perform."
    y "At least, I hope it will."
    y "We haven't even rehearsed yet, so at this point I have to have confidence in that idea."
    mc "Interesting take on things."
    mc "Is it working out for you?"
    y "I suppose so."
    y "I'm not really that nervous or worried, like I thought I would be."
    if yuri_date:
        y "And besides...tomorrow, we'll get to spend the time after our play together."
        ...
        y "We'll have to explore more of what the other clubs have to offer."
        ...
        y "...Yes, I suppose we haven't."
        mc "I was going to take you out to dinner afterwards."
        mc "T-That is, if you want and you're not busy."
        y "Oh, [player]!"
        y "I'd be more than happy to go with you!"
        "Yuri wraps her arms around me in an embrace."
        mc "I'm glad."
        y "Though, we should probably finish these preparations."
        y "There's quite a bit more to do."
    else:
        y "And besides...tomorrow, after the play..."
        y "I'll get to spend time alone."
        y "If it comes down to it, I can just never show my face again."
    ...
    y "It shouldn't really matter."
    y "We've almost finished the book."
    y "...Or at least, I have."
    y "That does mean I can't spend all of my time here."
...
label ch15_exclusive_natsuki:
    ...
    mc "If you say so."
    n "Come on, you seriously can't think that wasn't weird."
    ...
    n "Our ride is right around the corner."
    mc "Wait...what?"
    if ch12_outcome == 3 or ch12_outcome == 1:
        n "My dad had to do some things in the city."
    ...
    if monika_type == 0 or natsuki_date:
        ...
        mc "What...?"
        n "And maybe even the rest of us."
        n "You have to tell me everything, [player]."
        n "Otherwise, I won't be able to do anything."
        mc "I really don't understand."
        n "Wait..."
        n "There's someone else."
        n "Isn't there?"
        mc "Natsuki...?"
        n "We're not alone, [player]."
    ...
    mc "Mostly."
    n "I really hope you don't mess this up."
    n "If our cupcakes aren't perfect tomorrow, I'm blaming you."
    mc "Me?"
    mc "But you're just as responsible!"
    n "I know my cupcakes are going to be perfect."
    mc "We'll see about that."
    n "First, we have to organize how many of each design we're going to do."
    ...
    n "Yeah...but she was more of an actor."
    n "That's not to say her baking was bad, it was just something she did for fun."
    n "Kinda like me."
    mc "That's pretty cool."
    n "Anyway, we need to get back to work."
    "Natsuki starts writing down something on a sheet."
    "I think it's the distribution of design per cupcake."
    n "Start getting the materials ready."
    n "After we're done, you should go straight home."
    n "That way it isn't too late when you finish the book."
    mc "I almost forgot about that."
    n "You're telling me you almost forgot about the most important part of tomorrow?"
    mc "..."
    n "Whatever."
    n "Just make sure you finish it."
    n "Otherwise, the play ending is gonna be weird."
...
label ch15_exclusive_monika:
    ...
    mc "The reflection?"
    m "Yeah, I hope it was a learning experience for you."
    mc "I guess it was a good activity for the club."
    mc "A shame Sayori wasn't here."
    m "Yes...that is quite unfortunate."
    m "But I have no doubt she'll be the star of the show tomorrow."
    mc "Star of the show?"
    m "She's going to be really important."
    m "Seeing as she's the president, she's going to need to be."
    mc "That makes sense...I think."
    m "Anyway, we should get moving."
    ...
    if monika_type == 0 or (monika_type == 1 and ch12_markov_agree):
        ...
        if monika_type == 0:
            ...
            m "Thank you."
            m "Really."
            m "I won't keep you too long."
            m "I know you have a book to read for tomorrow."
            m "Hopefully, you've almost finished it."
            ...
            m "You know the one."
            m "Red cover, ominous eye."
            "Monika giggles."
            m "Oh, and that other one."
            m "For the club."
            m "But the first one is a priority."
        ...
        m "I need you to be properly indoctrinated when I start tomorrow."
        m "I can tell you've almost finished the book."
        m "That's good, it means you'll have time to read the other book too."
        m "The one for the play."
        m "Whatever the case, you must prioritize reading Portrait of Markov first."
        m "It's much more important."
        m "But I know you'll somehow get them both done."
...
label ch15_exclusive_sayori_alone:
    ...
    s "You should knock first, you know."
    ...
    "But it's not there."
    mc "I swear..."
    s "Maybe you need some rest, [player]."
    s "Just go home."
    mc "I can't."
    ...
    s "I told you, I needed to do something."
    s "But I came back."
    ...
    s "You're not going crazy, [player]."
