...
label ch9_yuridate:
    ...
    "Maybe it would be a good idea to talk to her about it."
    "Before I can open my mouth, the food we ordered arrives."
    "The waitress places a cheap looking dish in front of me."
    "It doesn't look quite appealing but I'm sure it probably tastes better than it looks."
    "Meanwhile, Yuri gets an intricate looking soup."
    "It isn't as big as what I ordered but it smells divine."
    "I'm sure it probably tastes just as good."
    y 3f "That was rather quick."
    "I guess I can always talk about it at another time."
    "I'd rather spend this time with Yuri than worrying about this weird feeling."
    mc "Usually this place is a lot slower."
    mc "I guess because there's not a lot of people here right now."
    y 2e "Do you think they prepared it beforehand?"
    y "It feels like we only just sat down."
    mc "No way."
    mc "This place isn't cheap enough to do that."
    mc "Trust me, the food is really good."
    y 1b "I'll take your word for it."
    "Yuri looks at her soup."
    "She sees the way I'm looking at it and smiles at me."
    scene y_cg6_base with dissolve_cg
    y "Do you want to share the soup?"
    y "The way you were looking at your food..."
    mc "N-No, it's fine."
    mc "I bought it for you."
    mc "I'm perfectly happy with this."
    "I take a bite out of what I ordered."
    "I don't expect much but it's surprisingly good."
    y "If you're sure."
    ...
    y "Wow..."
    y "This soup is more than I was expecting."
    mc "What do you mean?"
    mc "Does it taste better than it looks?"
    y "I would say the taste is even with how it looks."
    y "That said, they did prepare this dish quite extraordinarily."
    y "I'm surprised it was done in such a short period of time."
    y "It's still quite warm too."
    "I stare at the soup in front of Yuri."
    "I kinda wish I ordered one as well."
    y "[player], you're drooling."
    mc "W-What?"
    mc "I am?"
    y "I really don't mind sharing this with you."
    y "I'm sure I won't be able to finish it all myself."
    y "And in return, you can share whatever it is you ordered."
    mc "Are you sure?"
    y "Of course."
    y "I'm not really a picky eater."
    "Yuri raises her hand to get the waiter's attention."
    "He approaches us and gives us an inquisitive look."
    y "Could we have another bowl, please?"
    "The waiter nods and quickly returns with a bowl."
    "Yuri pours about half of the soup into my bowl."
    y "There."
    "I make my best attempt to give around half of what I ordered."
    ...
    "I can't help but feel I got the better end of it though."
    "Was that her intention?"
    "These subtle things she's doing for me really make me feel like we have a connection."
    "But then again, I did pay for everything..."
    y "I've been meaning to ask you something."
    mc "What is it?"
    y 1f "I noticed earlier when I was talking about my head."
    y "You had this expression on your face."
    y 2h "As if you could relate to what I was saying."
    mc "You could notice something like that?"
    y 2e "It was just a feeling I got."
    y "And I don't know if it's right."
    y 2h "Am I wrong?"
    mc "You know, that's funny."
    y 3q "What is...?"
    mc "I was about to ask you something about your head."
    mc "Then the food arrived."
    y 3f "That's odd."
    mc "Ahaha, it was some timing."
    mc "The thing is, I was sort of feeling the same."
    mc "I don't know if that's a coincidence or just me..."
    y 3k "I see..."
    mc "Anyway, it's probably not a big deal."
    mc "We've got something to deal with right now."
    mc "And that's the food in front of us."
    y 3a "Right."
    y "What did you order anyway?"
    y 2q "I hope you didn't buy something cheap because of me."
    mc "Of course not..."
    "That's a lie but I don't want to make her feel bad because of what she ordered."
    "Yuri takes a slice of the food I offered her."
    "She chews on it for a while, as if she was evaluating it."
    "After a few more moments, she swallows it."
    y 2s "That's not the worst thing I've had."
    mc "I was surprised myself."
    menu:
        y "Do you actually like it?"
        "Yes.":
            mc "It's pretty good."
            mc "And for a small cafe, it's a good meal for lunch."
        "No.":
            mc "I can't say I enjoyed it."
            mc "But I suppose I've had worse meals."
    y 3f "You've never ordered that before?"
    mc "Not really..."
    "Is she trying to figure out if I ordered something cheap because of her?"
    mc "I-I guess I wanted to try something new."
    y 1h "Really...?"
    y "Then why don't you try the soup?"
    y 1a "You haven't had it before, have you?"
    mc "No, I haven't."
    y 1b "You seemed pretty excited for it before."
    y "And since you're eager to try new things..."
    mc "You know what?"
    mc "I'll do that now."
    y 1j "Yeah..."
    "With the soup this close to me, I can almost smell all the ingredients in it."
    y 1u "Hmm..."
    "Yuri looks out into the distance."
    mc "What is it?"
    y 1v "I-It's just..."
    "The soup smells even better than before."
    mc "What?"
    "I grab a spoon and bring it towards my mouth."
    y 3v "Do you think Sayori knows anything about these missing memories?{nw}"
    $ _history_list.pop()
    show screen tear(20, 0.1, 0.1, 0, 40)
    window hide(None)
    play sound "sfx/s_kill_glitch1.ogg"
    ...
    hide screen tear
    window show(None)
    "We're already finished eating our meals.{fast}"
    window auto
    "I head to the counter to pay the bill."
    "Even though we shared dishes, it feels like I had none of the soup at all."
    "Maybe it didn't taste as good as I thought."
    "Or maybe it was so good that my mind already forgot about it so I could experience it all over again."
    "Who knows...?"
    scene bg residential_day
...
label ch9_end:
    ...
    if yuri_date:
        ...
        m "But..."
        m 1bm "Ahaha, it's trying its hardest..."
        m 1bn "Forgive me but it's what's best for everyone."
        m 1be "{i}You'll{/i} have control of [player_reflexive] without its influence."
