...
label ch9_school:
    ...
    m "I'm sure he'd do the same for you..."
...
label ch9_end:
    if yuri_date:
        ...
        m 1be "{i}You'll{/i} have control of him without it's influence."
        ...
        m "It does have access to his thoughts through me."
        m 1bg "Ah..."
        ...
        if y_appeal == 3 and play_firstpart and did_all_tasks and visited_yuri_hospital:
            ...
            if m_appeal == 3 and did_all_tasks:
                ...
                if ch5_name == "Monika":
                    ...
                    m 1m "I hit that 'you' with a keyboard and he fell unconscious."
                else:
                ...
                m "I'll try to be quick here because it could be bad if he wakes up."
                m 1e "It may not have been obvious..."
                m "But I can sort of read his thoughts too..."
                m 1h "Every time he thinks of something, I can just hear it in the back of my head."
                m "It's a little difficult to tell the difference between him speaking and him thinking."
                m 1c "So I kinda messed up in the club today..."
                m 1d "Thankfully, it didn't really matter too much."
                m 1f "What does is what he said to Sayori..."
                m "He's starting to remember that she wasn't the first president."
                m "And..."
                m "We both know what will happen when he finally regains his memory."
                ...
                m "You don't even have full control over him."
                m "..."
                ...
                m "He's already at his house."
                m "I'll need to talk to him about some things..."
                m "He'll be expecting me, so it's okay."
            else:
    ...
    if m_appeal == 3 and did_all_tasks:
        ...
        m "Right?"
        m "So you knew I could read his thoughts?"
        m 1bh "Well..."
        m "It doesn't matter."
        ...
        $ style.say_dialogue = style.normal
        m 1be "As long as {i}he{/i} has the real control over [player]..."
