...
label ch13_exclusive_natsuki:
    ...
    s "I was just checking up on here for a little while."
    s "In fact, I just finished talking to her."
    mc "Really...?"
    mc "How long did you talk for?"
    s "Oh, just a couple of minutes."
    ...
    s "Ehehe, I guess you could say I used a shortcut."
    ...
    s "Before I go, I just want to tell you..."
    s "Be careful of what you say, [player]."
    mc "What do you mean?"
    s "This is kind of a sensitive time in her life."
    s "So..."
    ...
    if ch12_outcome == 3:
        ...
        mo "She is! Have you come to talk to her like Sayori did?"
        mc "Actually, I was planning on talking to her about the event happening at school on Friday."
        mo "Oh...Inauguration Day or something, right?"
        ...
        mo "I'm sure she'd appreciate that."
        ...
        mc "It's a--"
        mo "The event that's happening on Friday, right?"
        mo "I overheard Natsuki and Sayori talking about it."
        mo "Sounds like it could be fun!"
        mc "May I speak to Natsuki then?"
        mo "Oh, how rude of me!"
        mo "Of course, she's in her room."
        mc "Thank you, Haruki."
        mo "No need to thank me!"
        ...
        mo "Just go to her."
        mc "Right..."
        mo "As for me, I need to finish cleaning the house."
        mo "Make yourself at home~"
        show haruki at lhide
        hide haruki
        ...
        d "I think so. She was just here talking to Natsuki about some sort of event."
        ...
        d "Ah, but you didn't come here to listen to me speak nonsense."
        d "You're hear for Natsuki."
        ...
        n "Y-Yeah, she was just here a minute ago..."
        n "She wants the club to do something for the day..."
        n "I think it was called Inauguration Day or something."
        mc "Yeah, that's it."
        mc "Sayori probably already told you what she wanted you to do, didn't she?"
        n "Baking..."
        n "Well...I suppose it's good that she can tell what I'm good at."
        n "That doesn't really explain why you're here though."
        ...
        n "Oh, so do {i}you{/i} think I'm incapable of doing things myself?"
        mc "You're misunderstanding me, Natsuki."
        mc "I chose to help you because out of everyone, I think you are doing the most work."
        n "W-What?"
        mc "And since you're doing the most work...I figured I should help you, right?"
        n "I..."
        n "...suppose that makes sense."
...
=======
        ...
        n "Hmph."
        mc "What?"
        n "That's depending on how fast you move, [player]."
        mc "What is that meant to mean?"
        n "It means hurry up and get to work!"
        "Natsuki smiles."
        mc "R-Right..."
        mc "What's first then?"
        ...
        n "I know just the thing to get rid of it."
        n "Wait here!"
        mc "W-Wait--"
        ...
        n "It's an air freshener!"
        mc "It doesn't look like one."
        n "Well, that's because it's not your normal air freshener!"
