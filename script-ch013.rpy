...
label ch13_natsukidate:
    ...
    n "Do you even know where you're going?"
    ...
    "Natsuki's face turns a bright red."
    n "J-Just get the menu, you idiot."
    mc "Alright."
    ...
    n "There's...so much choice."
    n "I've never seen such a big dessert menu before."
    n "I don't even know what to order."
    ...
    n "No...I think I need something sweet right now."
    n "I just...don't know what to get."
    n "Maybe the crème brûlée?"
    n "No...maybe not."
    mc "The...what?"
    n "You know, the crème brûlée."
    "Natsuki shows me the item on the menu."
    mc "Oh, you mean the creme brulee?"
    n "No, it's pronounced {i}crème brûlée{/i}!"
    mc "I can't tell the difference."
    n "You need to pronounce it with the accents."
    n "See those little marks above the letters?"
    mc "Yeah...?"
    n "That determines how that letter is said among other things."
    ...
    mc "It doesn't?"
    n "No, it's just a thing some words have."
    ...
    n "Yeah...not what I expected."
    mc "What did you expect?"
    n "I don't know...something normal, I guess?"
    ...
    n "I don't want to believe that but with all the things that have happened to me throughout my life..."
    ...
    mc "Than with you..."
    n "...Y-You're doing it again."
    mc "Do you want me to stop?"
    n "D-Do what you want."
    mc "Okay."
    ...
    n "He's probably an alcoholic or something."
    mc "What makes you think that?"
    n "I don't know, just the feeling I get from him."
    n "It's similar to how my dad was before he changed."
    mc "I see..."
    n "I still trust him with the portrait though."
    ...
    n "Like how you paid for my food even though I said I was gonna pay for myself."
    mc "Huh? How did you figure that out...?"
    n "It said on the menu you had to pay before getting your food."
    mc "Oh..."
    n "That's really nice of you, [player]."
    ...
    mc "I don't want to."
    n "I can't depend on you for everything, [player]."
    mc "I know."
    ...
    mc "It has?"
    n "Yeah, just something about Naomik seems so familiar."
    ...
    n "Maybe if we rearrange the letters."
    mc "That's a really random idea."
    n "Do you have a better idea?"
    mc "Well...no."
    n "Give me that pen."
    ...
    n "Maybe you'll remember or something..."
    n "Let's see..."
    "Natsuki writes down another combination of the letters."
    n "Mokina?"
    mc "I don't think so."
    n "Ugh, we're so close!"
    n "I can feel it."
    ...
    n "It's number fifthteen, like I said."
