...
label ch13_exclusive_natsuki:
    ...
    if ch12_outcome == 3:
        ...
        if n_appeal >= 4 and n_appealS >= 1:
            ...
            n "{i}My dad{/i} if there's any supplies."
...
label ch13_exclusive_monika:
    ...
    if monika_type == 0:
        ...
        "The more people that understand what our play is about, the more likely they'll be interested in joining."
...
label ch13_natsukidate:
    ...
    n 1bc "I went inside. They seem open but there's no one there..."
