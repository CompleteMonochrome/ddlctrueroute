...
label ch13_exclusive_natsuki:
    ...
    if ch12_outcome == 3:
        ...
        mc "What do you mean?"
        n "Haven't the events of the past few weeks been seriously weird?"
        n "I'm not the only one that's noticed that, am I?"
        mc "You definitely aren't..."
        n "And there's lots of blanks when I try to think of certain times."
        ...
        n "I've got two questions for you, [player]."
        ...
        mc "..."
        n "Yeah...that was my reaction too."
        ...
        n "I'm missing parts of that day. I thought you might be too."
        n "It's also because I thought it was the last normal day we've had."
        mc "Last normal day...?"
        mc "The days that came after weren't that bad, were they?"
        n "Some weird things happened."
        ...
        n "For my sake, I hope it's just normal."
        ...
        "The overwhelming smell of alochol is still there."
        ...
        n "I know there's no way he can hurt me anymore but..."
        mc "It's conditioned into your brain, right?"
        n "Um...I guess you could put it like that."
        "Natsuki sighs."
        ...
        n "All the volumes of manga I've never read..."
        ...
        n "There's two reasons, [player]."
        mc "Two reasons?"
        n "The first one should be obvious."
        ...
        n "Maybe the plastic wrapping was gone or some other really small detail."
        ...
        n "It's because when my mom left, he turned into some kind of investigator."
        n "He would search for clues and any other detail to try to figure out where she went."
        n "Eventually he gave up and turned his attention towards me."
        ...
        n "He made some stupid rules up that I had to follow."
        ...
        n "It's not like you can change that."
        mc "If I could..."
        n "There's no point thinking about what could have been."
        n "It just makes everyone bitter, [player]."
        mc "I guess..."
        n "Anyway, he was able to figure out when I broke one of his stupid rules because he could investigate if anything was wrong."
        ...
        n "He was really dedicated when he was searching for her...and I admired him for it."
        n "But that admiration turned into resentment."
        ...
        n "To be honest, it's good to say what I've been keeping a secret."
        ...
        mc "A game?"
        mc "What do you mean?"
        n "When I was younger, I'd play these games with my parents."
        ...
        n "It didn't hurt anyone and it was fun!"
        ...
        mc "That is..."
        n "I know it's a stupid reason."
        n "But it reminded me of better times."
        "Natsuki smiles faintly."
        n "It's hard to say all of this. It's like I'm trying to prove myself to myself."
        ...
        n "How far...Yasuhiro would go to hurt me and how dumb I am for thinking it's all a game."
        ...
        n "So, we're here to clean this room."
        ...
        n "You said you'd help clean if I told you."
        n "So don't complain."
        n "I'm going to get a basket or something to get some of these books out of here."
        mc "Why not just leave them in here?"
        n "It gives me a bad feeling just going in here."
        n "Anyway, I'll be right back."
        show natsuki at lhide
        hide natsuki
        ...
        "It's seperated from the rest of the markings with a huge space."
        ...
        if ch13_cleaneye:
            ...
            n "Fifty...that's about how many days he spent looking for her."
            ...
            n "Maybe he was keeping track of it."
            ...
            n "Now that I'm closer to it, I can smell it."
            mc "I think it is."
            ...
            n "What's even more creepy is that it's a perfect drawing."
            n "It looks so realistic..."
            n "And I know Yasuhiro, he was no artist."
            mc "Maybe it wasn't him?"
            n "Who else could it have been...?"
...
label ch13_exclusive_monika:
    ...
    if monika_type == 0:
        ...
        m 3i "The song is actually rather easy to play...and that's coming from a beginner!"
        ...
        m 3hb "I'm actually writing my own song right now."
        ...
        m "Of course not!"
        m 2hc "I was thinking of playing some smaller, easier songs to accompany the main piece."
        m "I don't really know what I should do, nor do I particularly mind."
        m 2hb "Which is where you come in!"
        mc "Me?"
        m 2ha "Yeah! You could be the one who finds me some songs to play."
        ...
        m 2hp "This song I'm composing is even for you..."
        m 2hq "Yet..."
        ...
        m 4b "And a longer, more iconic song as the main attraction..."
        ...
        m 4a "The song I've been practicing."
        m "It seems fitting."
    ...
    m "In the meantime, why don't you use my laptop and come up with some songs I could play?"
    mc "Alright..."
    show monika at lhide
    hide monika
    ...
    if monika_type == 0:
        ...
        m 2ba "I'm going to start practicing these songs you've chosen."
        ...
        m 1br "Thank you for choosing these songs, [player]."
        ...
        m "So thank you."
        "Monika smiles meaningfully."
        m 1bhb "I'm gonna try to play these songs you've chosen."
        m "Care to listen?"
        mc "I'd love to."
        ...
        "Monika looks away for a second."
        "She then turns back and smiles meaningfully."
        m 1bhq "Thank you for choosing these songs, [player]."
        m "I really appreciate you taking your time to help me."
        mc "It's not a problem, really."
        ...
        m 2bhn "I'll get the other songs done, don't you worry."
        ...
        m 1be "I suppose that's fine, it just means I can focus on this song I'm practicing now."
...
label ch13_exclusive_sayori:
    ...
    mc "Do you think so?"
    s 1ba "Everyone is probably gonna choose a popular book too, since it's a public performance."
...
label ch13_natsukidate:
    ...
    n "It's pretty easy to look over at your phone."
    "Natsuki looked at my phone while I was talking to Sayori?"
    "Just how much did she see?"
    n "Don't worry, I didn't see too much."
    n "But you should really be careful how you hold your phone."
    n "People might be looking."
    mc "You were the only one looking..."
    n "Well, yeah! What if someone who wasn't so close to you was though?"
    n "What would they do if they found out about Mr. Cow?"
    mc "...!"
    "Natsuki shows a wide smile."
    n "I'm not going to tell anyone!"
    n "I don't want to ruin this time with you."
    ...
    n "So don't joke about something like that, please."
    mc "I'm sorry, I shouldn't have said that."
    n "..."
    n "You can make it up by hurrying your pace!"
