...
label ch13_exclusive_monika:
    ...
    if monika_type == 0:
        ...
        m "I was kinda doing this for a special occassion, to mark something."
        ...
        mc "How long have you been praciticing it for?"
        ...
        m "Not to mention clear your memory of any knowledge of it, effectively removing almost all my influence in this world."
    ...
    m "In the mean time, why don't you use my laptop and come up with some songs I should play?"
    mc "Alright..."
    show monika at lhide
    hide monika
