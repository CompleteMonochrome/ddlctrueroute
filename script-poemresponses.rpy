...
label ch1_m_end2:
    ...
    if monika_appeal[0]:
        mc "I can sort of understand the meaning behind it but..."
...
label ch2_m_end:
    ...
    if monika_appeal[1]:
        mc "Like I said before, I take inspiration from you."
        mc "So I guess in a way, I do like it."
        m "Alright."
    else:
    ...
    mc "I see..."
    if monika_appeal[1]:
        mc "Even if I can write like this, it's still hard for me to determine what others are about."
    else:
    ...
    return
label ch3_m_end:
    # Sayori Important Twice Before Chapter but Ignored this Chapter
    if sayori_save == 2 and ignore_sayori:
        call showpoem (poem_m3b)
    # Sayori Important All Three Times
    elif sayori_save == 3:
        call showpoem (poem_m3b)
    else:
    ...
    # Player makes her regret
    if sayori_save == 3:
        m "But still, what if the answers we seek remove our meaning?"
        mc "I get what you mean."
        mc "It's why I've been writing like I do."
        mc "About our meaning and existence."
        m 1m "In a way, it's paradoxical."
        m 1p "The way I seek my answers, I might just..."
        m 1a "Ah, never mind."
    # Player appeals to her but doesn't make her regret version 1
    elif sayori_save == 2 and ignore_sayori:
        m "Hmm..."
        m "Maybe I could have wrote this differently, now that I look back on it."
        mc "How so? It seems pretty good to me."
        m 1e "Well, some things you said in the past couple of days made me think like this."
        m "But after today, it just feels like it's wrong."
        m "Maybe the Lady shouldn't be feeling regret in that last section."
        mc "Well, I'm not sure I get the message of the poem entirely but maybe everyone should feel regret."
        mc "Even if it's just a little."
        m "You could be right."
        m 1d "Still, in a way, the message in my poem is almost paradoxical."
        jump m_monika_3_shared
    # Player appeals to her but doesn't make her regret version 2
    elif monika_appeal[2]:
        m "You get what I mean, right?"
        mc "Yeah, I think I do."
        mc "It's why I've been writing like I do."
        mc "About our meaning and existence."
        m 1m "In a way, it's paradoxical."
        label m_monika_3_shared:
        m 1a "If we find all the answers, wouldn't the world start to lose its meaning?"
        m "As for me..."
        m 1b "I find new answers to my questions everyday..."
        m "And my life still has as much meaning as the day before."
        m 2a "What about you, [player]?"
        mc "I've never really thought about it."
        mc "But if I had to answer..."
        mc "I guess it really is paradoxical, I wouldn't want the world to lose it's meaning..."
        mc "But I also won't stop seeking answers."
...
label ch2_n_bad:
    ...
    if n_poemappeal[0] < 0:
        ...
        label ch2_n_bad_sharedwithch3:
            ...
            if monika_appeal[1]:
                mc "N-No! As a matter of fact it was written for M--"
                n 1x "You know Yuri would love this kind of...this angsty.......!!"
                mc "W-What? This isn't even for her! I mean she's talented and all but..."
            else:
...
label ch2_n_med:
    ...
    if n_poemappeal[0] < 0:
        ...
        label ch2_n_med_shared:
            if monika_appeal[0]:
                n 2c "Come to think of it, this kind of reminds me of Monika's poem from yesterday..."
                mc "Eh? You think so?"
                n 2j "Yeah. It's a little odd since I didn't think you too knew each other well."
                n 2k "But you never really struck me as her type."
                mc "Monika has a 'type' all of a sudden...?"
                n 42c "Well, I don't know! But honestly, how can someone so...er, popular...spend so much time with someone like you?"
                n "It's like she's got the whole school in her hands."
                mc "Uug... That was a little unnecessary..."
                mc "You think? Well what about Sayori?"
                n "I don't know...she seems really...fluffy?"
                mc "Ah...alright."
...
label ch1_s_med:
    ...
    mc "Am I the kind of [player_casual] who would be writing poems in [player_possessive] spare time?"
...
label ch3_s_bad:
    ...
    if n_poemappeal[2] > y_poemappeal[2]:
        $ currentname = "Natsuki"
        if m_poemappeal[2] > n_poemappeal[2]:
            $ currentname = "Monika"
    elif m_poemappeal[2] > y_poemappeal[2]:
        $ currentname = "Monika"
    s "..."
    s 1k "...Hm."
    s "It's nice, I guess~"
    ...
    if act_one_dialogue[0] or act_one_dialogue[1]:
        ...
        mc "It could just be a coincidence!"
    else:
    ...
    if act_one_dialogue[0]:
        "But obviously it was more than that from what Monika told me."
    mc "Alright..."
    ...
    if act_one_dialogue[0]:
        "Monika said she needed some time to think. I'll trust her with Sayori."
        "Still, I can't help but feel worried about her."
    $ skip_poem = True
    return
...
label ch3_s_good:
    ...
    s "I really thought that you would try writing your poems like the way Yuri or Natsuki do..."
    s 1y "Or even Monika..."
    s "But in the end..."
    mc "...Yeah."
...
label ch1_y_good:
    ...
    y 4c "I...!"
    y "Uu..."
    y "{i}([cPlayer_personal]'s going to hate me...){/i}"
    mc "Um..."
...
label ch3_m_start:
    ...
    if monika_appeal[1]:
        m "The poems you write are amazing anyway~"
    else:
...
# Monika wins appeal first stage
label m_monika_1:
    $ monika_appeal[0] = True
    m 2d "What..."
    "Monika looks surprised."
    if poemsread == 0:
    ...
    m 2e "No it's just...I wasn't expecting this."
    m 2b "Don't misunderstand, I liked it!"
    m 2e "I just thought you'd write something that relates to someone else."
    mc "Why is that?"
    m "Well...never mind actually."
    m 1a "I appreciate you sharing it with me."
    m 1g "{i}(It's almost like you know.){/i}"
    mc "What was that?"
    m 1a "Nothing~!"
    m 4b "Anyway, your poem seems like something I would write."
    m "I just didn't realize you were capable of writing like this."
    mc "Yeah, maybe I should look at some other styles."
    m 4b "Are you sure you want to?"
    m "Writing like this isn't a bad thing, you know."
    mc "Ah, you may be right."
    mc "I'm just happy you like it."
    mc "From your reaction, I was expecting the opposite!"
    m "I'm sure your writing can only get better."
    m 4e "And just because I said I like this style of writing doesn't mean you can't explore other styles too."
    return

# Others win appeal second stage
label m_natsuki_2:
...
#Monika wins Appeal second stage
label m_monika_2:
    ...
    mc "W-Well...to be honest I think you have been inspiring me."
    mc "At least, a little."
    m 2j "I appreciate your honesty, [player]."
    m "You don't have to take all your inspiration from me."
    m "You can look to the other club members as well."
    m "And I know you feel closer to Sayori seeing as you grew up with her..."
    m 2d "But Yuri and Natsuki are super interesting people, so don't be afraid to give them their share of time too!"
    m 2l "That's not me saying I don't like spending time with you or anything..."
    m "In fact, I quite enjoy our little chats."
    m 1e "I sure hope I'm not sounding weird here."
    mc "Ah, no, it's nothing like that..."
    mc "I'm just still getting used to being here, that's all."
    m 1a "Yeah..."
    m 1l "I'm sorry if I was putting pressure on you or something!"
...
label m_yuri_3:
    ...
    #Monika wins appeal third stage - appeal variable handled elsewhere
label m_monika_3:
    if sayori_save != 3:
        m 2f "Well then..."
        "She doesn't look too happy to read this."
        "Maybe I should say something."
        mc "S-Sorry, I just thought--"
        m 2b "It's alright [player], it's not bad."
    else:
        m 2q "Sorry."
        if poemsread == 0:
            "What's this? Has my writing gotten worse somehow?"
        else:
    ...
    m "Our writing styles ended up being really similar."
    mc "If it makes you feel uncomfortable I can stop trying to write like you."
    m 1l "No...if this is the way you write..."
    m 1j "Who am I to tell you otherwise?"
    m "I did say I'd help you find your own writing style."
    m "It just happens to be like mine~"
    mc "I just enjoy this style of writing."
    mc "It invokes a strange sense of thinking within me."
    m 2b "It does, doesn't it?"
    m 2e "I'm a little shocked, I thought your poems would eventually become more like Sayori's."
    mc "Huh?"
    m "Well...you two grew up together, didn't you?"
    mc "I'm not going to change who I am because Sayori and I started walking together again."
    m 1n "Ah..."
    mc "I've been treating her like I always do and I don't plan on changing that."
    m 2a "Alright."
    m 2e "Just making sure~"
    m "I know how much you care about her..."
    m "..."
    m 2d "Sayori's been acting so much happier ever since you joined the club."
    if act_one_dialogue[0]:
    ...
    if sayori_save != 3:
        ...
        m 1p "It isn't the time for this..."
    return
