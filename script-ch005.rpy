...
label ch5_main:
    ...
    if not ignore_sayori:
        "Besides, Monika was out helping her the whole weekend."
        "She probably went to get Sayori."
    ...
    if act_one_dialogue[0]:
        m 1q "Ah, Sayori isn't with you."
        mc "I thought she'd be with you."
        mc "Seeing as you helped her and everything."
        m 1f "I'm sorry."
        mc "No, I should be the one sorry."
        mc "I promised I'd come on Saturday..."
        mc "But there seemed to be no time that day."
        "What did I even do on Saturday?"
        m 1h "No, it's not {i}your{/i} fault, [player]..."
        "Monika sighs and finishes placing the pamphlets around the room."
        mc "Did you end up making her feel better?"
        m 1g "I tried [player], I really did."
        m "I don't know if it was enough."
        mc "I'm sure she's fine, she probably just overslept again."
        ...
        m "After hearing about your exchange yesterday..."
        m 1q "I really left her hanging this morning."
        mc "No, I should have been the one to wake her up."
        mc "Wait...did you say exchange?"
        ...
        m 2o "You know, [player]..."
        m "I wish I didn't."
        mc "Eh...?"
        "Monika is being unusually down and for some reason, just the way she said that..."
        "I could feel a chill down my spine after hearing that."
        m 2e "Well, while you're here you might as well check the pamphlets."
        ...
        if not ignore_sayori:
            ...
            mc "Well, I thought you would get her."
            mc "Seeing as you were working with her on the weekend."
            mc "Still you'd think that on days this important, she'd try a little harder..."
        else:
            m 1d "I'm surprised you didn't bring Sayori with you."
    ...
    if act_one_dialogue[0]:
        ...
        "But more than that..."
        mc "I need to go get Sayori, so..."
        m 1q "Alright..."
        m "Just...go."
        m "She's more important."
        mc "I didn't mean it like tha--"
        m 1m "Just, try not to take too long, okay?"
    ...
    if act_one_dialogue[0]:
        "I should have went over on Saturday."
        "What am I doing, breaking a promise like that?"
