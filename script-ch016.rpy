...
label ch16_main:
    ...
    if yuri_approval >= 3 and natsuki_approval >= 3:
        ...
        n "I guess I am some kind of hero, aren't I?"
        n "But it wasn't really a solo effort."
        ...
        n "You know, to see if it was made well."
        mc "Sure you were."
        ...
        n "My guess is that the ones they gave us were prepared beforehand."
