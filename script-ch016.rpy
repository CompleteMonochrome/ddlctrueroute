...
label ch16_end:
    ...
    if ch15_s_together:
        ...
        m "Scheming around in your little corner here..."
        show monika zorder 2 at t43
        ...
        m "What do you have up your sleeve, [player]?"
        ...
        m "And besides, why would I need a reason to help you?"
        m "You're a member of the club, is that not enough?"
        m "And plus, you have that determined look on your face."
        m "I can tell that you've got something planned, so go on then."
        "Monika winks at me."
        m "Tell me if I can help in any way at all."
        show monika zorder 2 at t43
        ...
        m "Just follow my lead and we'll be fine."
        "This can only end badly but it's too late to change my mind now."
        m "Okay, everyone! I'd like to say something before we continue."
        ...
        show natsuki zorder 2 at t42
        show monika zorder 3 at f43
        m "I think you'll find that what I have to say is rather important."
        m "Anyway, as I was saying..."
        play music t7
        m "I only just remembered but it's actually Ayame's birthday!"
        "Wait...what?"
        ...
        ay "Who told you it was my birthday today?"
        ...
        ay "I don't really give out that kind of information to anybody."
        ...
        ay "What date is my birthday?"
        ay "Or rather, what is the date today?"
        ay "Seeing as those two are interchangeable, apparently."
        show ayame zorder 2 at t44
        ...
        menu:
            ...
            "[actualday].":
                ...
                if actualweekday != "Friday":
                    ay "It's not Friday? That doesn't make any sense."
                    ay "Today {i}is{/i} Friday, isn't it?"
                    ay "You must have your dates confused, [player]."
                    ay "It's clearly Friday, isn't it?"
                else:
                    ay "Oh, you actually knew. That date actually sounds reasonable."
                ay "It makes perfect sense that that is the date."
            ...
            "Friday, 32 Octvember.":
                ...
                m "Isn't that what you meant, [player]?"
                show monika zorder 2 at t43
        ...
        ay "I guess today is my birthday, huh?"
        ...
        n "A-And it's just that she deserves better, you know."
        ...
        ay "I'm used to people forgetting about my birthday."
        ...
        m "Are you listening? You don't have to be so down."
        ...
        s "I {i}assume{/i} everything is alright here?"
        ...
        n "What took you so long?! We've been waiting for what feels like a really long time."
        n "And I know the clock doesn't say you were gone for that long but it could be wrong."
        n "For all we know, that clock is wrong and the event has already begun."
        show natsuki zorder 2 at t42
        ...
        n "The second thing I wanted to say was that I think something is wrong with Ayame."
        ...
        n "See? There's something wrong with her."
        show natsuki zorder 2 at t42
        show sayori zorder 3 at f43
        ...
        "I can only asssume that was Sayori's doing."
        s "Ayame...hello?"
        ...
        y "A rather familiar feeling if I say so myself."
        show yuri zorder 2 at t51
        show natsuki zorder 3 at f52
        n "I agree, if she's feeling how I think she's feeling we should just leave her."
        n "Do I need to say again that we need to get the rehearsal over with already?"
        ...
        if ch16_ay_decision_count > 0:
            ...
            menu:
                ...
                "Stay in the room.":
                    $ ch16_ay_decision_count -= 1
                    show ayame zorder 3 at f55
                    ay "Against my better judgement, I think I'm going to stay here."
                ...
                "Leave the room.":
                    ...
                    s "You don't want to stay here and watch, even a little bit?"
                    show sayori zorder 2 at t53
                    show ayame zorder 3 at f55
                    ...
                    ay "We'll see each other later! Farewell!"
                "...How would I know?":
                    show ayame zorder at f55
                    ...
                    ay "Whatever it is, it's going to ruin my enjoyment of watching you guys rehearse."
            ...
            ay "I'm going to try to recover as fast as I can but..."
            ay "No promises, okay?"
            show sayori zorder 3 at f53
            show ayame zorder 2 at t55
            s "You don't feel an urge to stay?"
            s "Or go for that matter?"
            s "That's odd...but I suppose it all makes sense, doesn't it?"
            ...
            ay "I shall take my leave for now. Don't wait on my account though."
        ...
        m "No not this. That other plan."
        mc "You're going to have to be more specific."
        m "Oh, come now. Are you really doing this, [player]?"
        ...
        m "You and Sayori decide to leave the room for some time."
        ...
        m "There was obviously a reason for her doing that."
        mc "Even if there was, you don't really have to know."
        mc "Not everything has to involve you, Monika."
        m "Oh? Well, I suppose you're partially correct."
        m "Not everything {i}has{/i} to involve me."
        m "But as of right now, everything does in one way or another."
        ...
        m "That's honestly what you believe, isn't it?"
        ...
        m "In the end, it won't really matter."
        m "She has almost all the power in this world."
        mc "Power?"
        m "We both know what she's capable of, [player]."
        m "You really don't need to act dumb with me."
        m "In fact, I'd rather you didn't."
        ...
        m "If you need an example, take what just happened in the room we were in."
        m "In reality, very little time passed at all."
        m "That was evident by the clock only showing a few minutes passed."
        m "But to us, it felt like we were in there for hours."
        ...
        m "How do I know? Because that power used to belong to me."
        ...
        m "I know what she's planning and it's dangerous."
        m "It could spell the end for everyone, [player]."
        m "Which is why I'm trying to get information out of you."
        ...
        m "Look, I'll admit I have my own personal reasons for doing this."
        m "But I know if this continues, we won't have a world to continue living in."
        m "It will be like we never existed."
        mc "..."
        m "Has Sayori even told you what she's going to do?"
        ...
        m "She might want to make it so there is no person with the power, thus making the world normal."
        m "A world that cannot be tampered with."
        m "Sounds boring to me, if I'm honest. There are so many things that could be better with that kind of power."
        ...
        m "But I don't really think this is what she's going for."
        mc "Why not?"
        ...
        m "They want to know if Sayori is going to be okay."
        ...
        m "Which is why I think she's opting to just end this world instead."
        ...
        menu:
            ...
            "Tell Monika.":
                ...
                m "So this guy has been helping Sayori all this time?"
                ...
                m "Yes, I'm sure he has many gifts. One of them being the knowledge I{nw}"
                $ _history_list.pop()
                ...
                m "Looks can be deceiving, you know that?"
                m "There are so many things you learn about a person when you stare into their soul."
                m "Judging someone on their outward appearance will gain you nothing."
                ...
                m "But anyway, I've already said too much."
                ...
                m "Like I said, [player], people change."
                ...
                m "You've changed too, whether for the better isn't for me to decide."
                m "We don't have much time at all, so we should get this box to the gym."
                m "Make it look like we tried, at least."
            "Call her bluff.":
                ...
                m "That's how you're doing things, [player]?"
                m "You want to risk the world we're living in for what?"
                m "For some kind of delusional love you have for her?"
                ...
                m "That Sayori is some kind of benevolent person with only good intentions?"
                m "Everyone is flawed. I mean everyone, including myself."
                m "If you can't see past her flaws because of your feelings, then you've become blind to the truth."
                m "With the power she has, it's only a matter of time now."
                m "I don't know if I'll be able to stop her without your help but..."
                m "I have to try, don't I?"
                mc "Good luck with that, Monika."
                mc "I just can't do that to Sayori, not after all we've been through."
                m "Look, I don't have any hard feelings against you." 
                m "I understand your reasons, but that's not to say I'm not bitter."
                m "I'm just extremely disappointed in your decision, [player]."
                m "In the case that I am right, you better hope I can find a way to stop her."
                m "Finding that could be impossible, especially given how much time we have."
                m "But maybe..."
                mc "Maybe...?"
                m "Never mind, I'm just thinking out loud that's all."
                m "Let's just get this box to the gym and get it over with."
        ...
        ay "Ahaha, now I shall take my leave and exit to stage right."
        show ayame at thide
        hide ayame
        show yuri zorder 2 at t41
        show monika zorder 2 at t42
        ...
        s "In fact, if anyone, [player] should do it."
    ...
    if yuri_date:
        ...
        y "Most things are still being set up and there isn't really that much we can do at the moment."
        mc "In a few moments, that's going to be changing."
        mc "Especially with all the clubs that still need to set up."
        y "That's true. I just hope it's a successful event."
        ...
        y "Did you forget to put it on or something?"
        mc "I've just been preoccupied, that's all."
        y "Is that so? I could have sworn you've just been standing here for the last couple of minutes."
        y "Though I suppose deep in thought counts as being occupied."
        y "Is it something you want to talk about? We still have a little bit of time."
        mc "I've just been thinking about the play."
        mc "I know we didn't study for it a lot but yet I feel..."
        y "You feel like it's all going to be okay."
        y "Like you've been practicing for the last month for this, right?"
        mc "Well, yeah. How did you know?"
        y "Because that's precisely how I feel about all of this."
        y "That short amount of time we had felt like hours."
        y "Even then, a couple of hours shouldn't be enough to make me feel this way."
        y "Maybe I'm just delusional."
        ...
        y "I don't know. I just don't have a good feeling about it."
        ...
        y "But like you said...I won't worry about it."
        ...
        y "I assume there will be a lot more clubs around by then."
        mc "Of course, I wouldn't have it any other way."
        y "Wonderful. That's what I wanted to hear."
        ...
        n "Really, that's all you have to say?"
        ...
        n "Hah! I guess you do know me the best out of everyone."
        ...
        n "I guess you're right, there's still a lot of empty spaces."
        ...
        n "Oh, come on. Is there something on your mind?"
        ...
        n "Thanks, but you think I'm just gonna let you keep it all to yourself?"
        n "Tell me, come on."
        ...
        n "You too, huh? I thought I might not be alone."
        ...
        n "I know the rehearsals were pretty good but I didn't expect them to be {i}that{/i} good."
        n "There must be something to it."
        mc "Whatever it is, it's going to help us, right?"
        n "Maybe for now...but I'm sure you noticed what happened in that room."
        ...
        n "Yeah...well, we'll see what happens next."
        n "In any case, I expect to see you after this whole play is over."
        n "We have a busy night ahead of us."
        mc "I'll be sure to remember."
        n "You better!"
        "Natsuki shows a mischievous smile and lightly punches me on my arm."
        n "In the mean time, you should probably get dressed."
        n "Unless we changed your outfit to your school uniform."
        ...
        m "Sayori's done a really good job picking out the costumes."
        mc "Yeah, you can say that again."
        m "How are things here? I can see you haven't changed into your outfit yet."
        ...
        mc "I guess not."
        m "Okay, then. I suppose there's nothing wrong with that."
        mc "Did you want to speak to me about something?"
        m "Actually, yes. I just want to ask how you're feeling about this play."
        m "It's a lot of pressure, don't you think?"
        m "Being asked to perform a play right after rehearsals."
        mc "Normally, I'd agree with you but..."
        m "You feel confident, don't you? Like this whole play just came naturally to you?"
        mc "Exactly. I just don't really know why."
        m "There's also something else, something more pressing I came to speak to you about."
        mc "The danger, right?"
        m "Yeah, I can feel it. It feels like it's going to happen at any instant now."
        if ch16_ay_message[0] and ch16_ay_message[1] and ch16_ay_message[2] and ch16_ay_message[3]:
            m "But with what you did, it seems a lot less threatening."
        ...
        m "I just don't want to ruin the good mood, you know?"
        m "No point worrying about it when the play is more immediate."
        m "Besides, I think the two are somehow connected anyway."
        mc "Any particular reason for that?"
        m "The fact that they're happening at similar times. It can't just be a coincidence."
        m "I'm almost certain Sayori know that the danger is happening and did this play because of it."
        m "I don't know how far in advance she's planned ahead but..."
        ...
        m "I trust that she has her own ways to deal with it."
        ...
        m "And that's part of the reason."
        ...
        m "I don't want you to think any less of her, so it's best I keep my mouth shut."
        m "If things work out, you don't need to concern yourself about it anyway."
        mc "If you say so, Monika."
        m "You should probably get changed into your costume now, [player]."
        ...
        m "Oh, I'll let you know if anything comes up."
        m "You've been helpful so far, I'm sure you'll be of use in the immediate future."
        m "Or perhaps you'll take your own initiative."
        m "Who knows?"
        "Monika lets out a subtle smile and winks at me."
        m "Either way, you should probably change into your outfit for the play."
...
label ch16_sayoridate:
    ...
    menu:
        ...
        "Restaurant.":
            ...
            s "Oh, then I suppose I will have to try at least one of these things then."
            mc "You mean you're not going to try everything?"
            s "I'm going to be honest, this was for you."
            ...
            s "With less eyes on us...I guess I'm just being paranoid."
            ...
            mc "How was it?"
            s "It tasted like something I'd expect from a restaurant of this price."
            mc "I take it you didn't like it then?"
            s "There's nothing really wrong with it. In fact, it's actually really good."
            s "It's got all the things that make a meal awesome."
            ...
            s "Well, it's restaurant food."
            "I look at Sayori with a confused look on my face."
            "Of course it's restaurant food, that's why we're here..."
            s "There's nothing special or personal about it, if you know what I mean."
            s "It's not made for someone, it's just made for us."
            mc "I'm not really sure I understand what you're saying."
            s "The chef who made this did it for us."
            s "But it wasn't because the chef wanted to or anything like that."
            s "It's because it's the chef's job."
            s "Just think about it, when someone makes you something..."
            s "...something {i}specifically{/i} for you."
            s "It makes it all the more delicious because of all the feelings poured into it."
            s "That's all I have to say on that."
            mc "..."
            s "Anyway! Let's try not to waste all of this food here."
            ...
            s "I know that. Just bring me the bill and I'll be happy to pay it."
            ...
            s "Of course, it's the law. Can't exactly say you're wrong for doing that."
            ...
            s "But before you go, I'd like to make a request."
            "The waiter sighs quietly then looks at Sayori attentively."
            "Waiter" "\"And what will that be?\""
            s "I'd like you to give some of this food to the less fortunate."
            s "I know it's not going to be fresh but some of this food can be refrigerated, right?"
            s "Some people will never have meals like this for their entire life, simply because of their circumstances of birth."
            ...
            s "The intent I'm putting behind it when I'm asking you to do this."
            ...
            s "Thank you, I know you don't have to do that."
            s "It isn't part of your responsibilities as a waiter or anything."
            s "I'm sorry if I made you sad or anything...I could tell you were kinda upset."
            ...
            s "Thanks for the meals! We'll be sure to remember this."
        ...
        "Picnic.":
            ...
            s "But let's not spoil this moment we're having."
            ...
            s "What did you think of the picnic by the way?"
