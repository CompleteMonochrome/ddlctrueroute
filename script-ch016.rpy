...
label ch16_end:
    ...
    if ch16_m_plantold:
        ...
        m "So in the end, you're not thinking about yourself."
        ...
        m "You've told me, and now I know."
        ...
        m "I want to live to see tomorrow, and by stopping her you do as well."
        m "Just because I have my own reasons doesn't mean you shouldn't help me."
        m "Besides, I found out something about this mysterious man you might want to know about."
        mc "And what would that be?"
        m "He isn't from this world, [player]."
        ...
        m "Apparently there are rumors of an impossible man."
        ...
        m "I didn't really follow this lead initially."
        m "It seemed too convenient, and there was no guarantee that it was the same person."
        m "But it all makes sense from what you told me."
        ...
        m "I don't know who this person could be but we can use that to our advantage."
        mc "I don't think he'll fall for a simple trick like that."
        mc "Someone's probably already tried it before you."
        m "Oh, I know. Which is why I have a secret plan."
        mc "And are you going to tell me what that is?"
        m "Then it wouldn't be secret, would it?"
        ...
        m "Even if you are, what can you do?"
        m "It's not like you can change this path you've gone down now, can you?"
        m "You should at least try to act like you want to see it through."
        ...
        mc "Monika--"
        m "You think what you two are doing is right?"
        ...
        m "And that's what's stopping me."
        m "She's taken measures to protect you, especially now."
        m "It's much stronger than ever before."
        if ch12_markov_agree:
            m "But I wonder, does she know about what you did?"
            m "Not in this timeline, but in a different one."
            m "Where your curiosity got the better of you?"
            m "I don't think she does."
            m "She might be powerful, but she's not completely omnipotent."
            m "That might be my last chance to make things work."
            m "Now, you wouldn't tell her about that, would you?"
            "Monika retracts her hand and smiles."
            m "Not like you have a choice in the matter."
            m "You'll do the right thing when the time comes."
            m "I've already made sure of it."
            m "So, take your time."
            m "Enjoy yourself, [player]. It can only last so long."
            m "Moments like this, those are the things you'll remember until the day you disappear."
            m "Ahaha, literally~"
            if ch16_ay_drink:
                m "Though you have complicated things, slightly."
                m "I don't know what was in that drink, but knowing Ayame..."
                m "I'll have to make sure it won't affect my plans."
            m "Good luck on the stage, [player]."
            m "I'm counting on you."
        else:
            m "And I feel like that this might be the end for me."
            m "Well...it was a nice try."
            m "I really thought I could finally escape."
            m "That I could finally be free of all of this."
            m "That's all I really wanted, you know?"
            m "The power to be free."
            m "But..."
            "Monika slowly pulls her arm back."
            m "I guess that was just never meant to be."
            m "I suppose..."
            "Monika breathes deeply and sighs."
            m "I suppose all that's left to do is to at least try to enjoy myself."
            ...
            m "Call me selfish, but I'd settle for repeating this cycle again."
            m "Self preservation and all that...it's one of our primary instincts."
            m "But forget about it."
            m "You don't need to hear me ramble about what could have been."
            m "[player]...do enjoy yourself, would you?"
            m "I'll try to do the same."
            m "No more schemes. I'm tired of it all."
    else:
        ...
        if ch16_ay_drink:
            ...
            m "Was that a very smart idea, [player]?"
            ...
            if monika_type == 0:
                m "Not until they have nothing left..."
                m "It's strange how we are, isn't it?"
                m "We build up these walls and come up with these strange personas that we show to others."
                m "And sometimes, we convince ourselves that we really are those personas we created."
                m "But deep down, even subconsciously, we know that what we're showing to others isn't really us."
                m "It's what we want them to see, so we can hide that part of ourselves."
                mc "Why are you telling me this, Monika?"
                m "Isn't it obvious who I'm talking about, [player]?"
                "Sayori..."
                mc "That isn't who she is anymore."
                mc "She's changed, I know she has."
                m "Oh, she's definitely changed [player]."
                m "She thinks she knows what's the best for us."
                m "I just...never mind. It's not my place to say."
            else:
                m "That is, until they're backed into a corner."
                m "With nowhere else to go or no one else to turn to."
                m "That's when you find out what someone's true nature is."
            m "Anyway..."
        else:
            m "Well, I don't know. You did decline Ayame's drink."
        ...
        if monika_type == 0:
            ...
            m "Because she wants us to be happy, even if that means our existence fades away..."
            "What does she mean by existence fading away...?"
            "What is Sayori up to?"
            m "She's got the intentions, but the means are not the way to go."
            ...
            if monika_type == 1:
                ...
                m "I wonder what our first act as the rulers of this world will be?"
                m "I want it to be a decision between the two of us."
                m "Everything we do after that point, we'll do together."
                m "I guess that's all there is to say for now, isn't it?"
            else:
                m "I should thank you again."
                ...
                m "I'm still wondering why exactly you went down this path."
                m "Maybe you're just stuck, maybe you're just curious."
                m "Maybe you're looking to betray me at the very end."
                m "I can't say I would blame you."
                m "You have your reasons, I'm sure."
                m "If that does happen to be the case, then come prepared."
                m "Because who knows what could happen?"
                m "If you really are just purely helping me..."
                m "Then I can't help but think you aren't in a proper state of mind."
                m "In any case, it's not my place to judge you."
            ...
            m "You choose her perceived 'right' way, or the way that leads to a future?"
            m "A future that maybe you have a chance to save..."
            m "As opposed to guaranteed doom and nobody wins."
            m "But you still have to play your role first."
        m "Good luck on your part, [player]~"
    show monika at thide
    hide monika
    ...
    # This happens during the play, I still have to write that part but this will be written while it's still semi fresh
    stop music
    ...
    ay "I hope I'm not overstepping my boundaries or anything."
    ...
    ay "She isn't in this time anymore, [temp_name]."
    ...
    ay "I have a feeling you will too."
    ...
    mc "Try...?"
    ay "I have no idea how they'll react to all of this, [temp_name]."
    ...
    menu:
        ...
        "Natsuki." if not ch12_markov_agree:
            ...
            ay "If you're sure about this decision, then let's do this."
            mc "I'm sure."
            ...
            "Right...I forgot."
            mc "What now?"
            ay "Well, I'm going to release her from this frozen period of time."
            ay "Only temporarily though, remember. We're on a timer here."
            ay "It would last longer but I couldn't complete the recipe."
            ay "I needed your help to finish it but when I went looking for you, I couldn't find you."
            ...
            mc "Hello."
            n "[temp_name] too?! Okay, what is going on?"
            n "Someone please tell me before I freak out."
            ay "Okay, there's no easy way to say this."
            ay "So I'm just going to say it. Promise me you won't freak out."
            n "Okay, fine. Just tell me already."
            ...
            ay "And we need your help."
            "Natsuki looks at Ayame, then turns towards me."
            n "Why me? Why not the others?"
            ...
            if natsuki_date:
                ...
                n "But for some reason, I believe you."
                ay "You don't know how much this means to me."
                ay "To all of us."
                n "Yeah, well...I couldn't exactly let [temp_name] handle this by [player_reflexive]self."
                ...
                ay "But Natsuki..."
                n "I can't! Okay?! I'm not ready for this."
                n "I have so much going on with me right now."
                n "And this? This is too much."
                ay "Natsuki, I didn't mean to--"
                "Ayame tries to put a hand on Natsuki's shoulder but Natsuki swipes it away."
                n "D-Don't you touch me, Ayame!"
                n "I know what you did, okay?"
                n "I didn't want to believe it, but it makes sense."
                ay "What are you talking about?"
                n "In the meeting, you made me defend you."
                n "I thought it was just me being nice, but no."
                n "You got into my head and made me think highly of you!"
                ay "I..."
                mc "You did that?"
                n "Because you were insecure! B-Because you couldn't fit in!"
                ...
                n "And yet, she thinks she has the right to do that."
                n "How do you know she hasn't changed your thoughts about her, [temp_name]?"
                n "She could have you wrapped around her finger and you wouldn't even realize it."
                mc "Ayame...?"
                ay "I won't deny that I did do that."
                ay "And whatever my reasons may be, they're not excusable."
                ay "But I'm asking you to think of your friends, of Sayori."
                n "I won't help you, Ayame."
                ...
                mc "Natsuki--"
                ay "Leave her, [temp_name]. She's right."
                ay "Bringing her along now, would only hinder us."
                ay "Come on, let's get out of here."
        ...
        "Yuri." if not ch12_markov_agree:
            ...
            ay "I hope you're right, [temp_name]. If this goes wrong, we don't have time to get another person."
            ay "I just hope she doesn't freak out."
            ay "Come on, let's go get her."
            $ _history_list.pop()
            show screen tear(8, offtimeMult=1, ontimeMult=10)
            window hide(None)
            $ pause(1.0)
            show yuri 1c zorder 2 at i31
            show ayame 2a zorder 2 at t11
            hide screen tear
            $ pause(1.0)
            window show(None)
            ...
            ay "Yuri! Are you okay?"
            $ y_name = "Yuri's Voice"
            y "A-Ayame? How am I hearing you right now?"
            ay "[temp_name] and I are talking to you through a sort of telepathic link."
            y "Telepathy? B-But that's just fiction."
        ...
        "Natsuki and Yuri." if not ch12_markov_agree:
            ...
            n "A-Are you okay? You look like--"
            ay "I'm fine. Or, I will be."
            ...
            if natsuki_approval >= 3 or natsuki_date:
                ...
                n "I owe it to [player_reflexive] to see this through."
                mc "I'm glad I could count on you, Natsuki."
                n "D-Don't get used to it, you know?!"
                if natsuki_date:
                    ...
                    mc "I'll keep that in mind."
                n "What exactly am I meant to be doing?"
            ...
            if yuri_approval >= 3 or yuri_date:
                if ch16_ay_companions == 6:
                    ...
                    mc "Yuri..."
                    y "So that's that. I'm helping you deal with Sayori."
                    y "I hope that she'll see reason."
                    ay "That's good to hear, Yuri."
                ...
                if ch16_ay_companions == 6:
                    ...
                    ay "W-What? Why not?"
                    y "I'm just not able to help you, Ayame."
                    ...
                    y "Help...that's something I wish I had."
                    ...
                    y "It's too late now, isn't it?"
                    ay "Yuri...I know how you feel."
                    y "How could you, Ayame? You barely know me."
                    y "You don't know what I've been through in my life."
                    y "...I'm sorry, I didn't mean to come off so rude."
        ...
        "No one." if not ch12_markov_agree:
            ...
            ay "I...can't say what I would do."
