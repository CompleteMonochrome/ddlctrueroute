...
label ch14_exclusive_natsuki:
    ...
    if natsuki_date:
        ...
        if ch12_outcome == 3:
            ...
            n "I'm glad you know who's the best around here."
            "Natsuki smiles triumphantly."
            n "But anyway, we should get to the preparations."
            mc "Sure, what were we going to do today?"
        n "Hold on, I actually had a list back in my room."
        ...
        n "I have a list of stuff right here."
        "Natsuki shows me a piece of paper."
        n "I already planned out the day according to the time we'd use."
    mc "That's really well organized of you."
    "Despite me saying that I can only see like two or three things on the list."
    n "One of us has to be."
    mc "E-Eh?!"
    n "The first thing on the list is..."
    n "We're gonna talk about the book we chose in the club."
    mc "Oh, alright."
    mc "That would make sense."
    n "We can't really bake right now."
    n "If we do that, it won't be fresh for the day."
    n "I do have an idea for what we can do after this though."
    n "So let's talk about this book."
    if ch13_natsuki_books:
        n "But first, I want to thank you."
        mc "What for?"
        n "You brought in one of my manga."
        n "We didn't choose it but..."
        n "It still means a lot."
    ...
    if ch14_overall_choice == player:
        ...
        n "You were..."
        n "...weren't you?"
        n "I'm not sure anymore, but I have a copy so..."
    elif ch14_overall_choice == "Natsuki":
        mc "Sure, but I don't exactly have a copy of your book..."
        ...
        n "Along with the next few volumes."
        mc "I do?"
        n "Are you messing with me right now?"
        mc "I can check but I really don't think..."
        ...
        mc "When did that get there?"
        n "You really don't remember borrowing it from the library?"
        n "We did it after the meeting, remember?"
        mc "I can't remember a thing."
        n "Yeah, we--"
        "Natsuki stops to think."
        n "I mean I think we did..."
        n "It makes sense, right?"
        n "Since your copy is just a loan from the library."
        "I open the book and find the borrower section."
        mc "Yeah, you're right."
        n "See? It makes sense."
    else:
        mc "Sure, but we don't exactly have a copy between us..."
        n "What do you mean?"
        n "I have mine right here."
        "Natsuki takes a copy of the book [ch14_overall_choice] showed in the meeting."
        n "Isn't it in your bag?"
        if ch14_overall_choice == "Sayori":
            n "Sayori gave everyone a copy."
            n "Which is weird since that's not usually like her."
            n "It's weird though, I can't really remember when she gave everyone a copy."
            n "Whatever, that's not really important."
        elif ch14_overall_choice == "Monika" and not (monika_type == 0 or (monika_type == 1 and ch12_markov_agree)):
            n "I'm sure Monika gave everyone a copy."
            n "How she had that many, who knows?"
            n "But...I can't really remember when she gave it to us."
            n "But that's not important."
        else:
            n "We all got a copy from the library, remember?"
    ...
    if ch14_overall_choice == player or ch14_overall_choice == "Natsuki":
        ...
        if natsuki_date:
            ...
            n "Let's try doing this together, then."
            mc "Sure, we can try."
            mc "I'm not sure how well it will work out."
            mc "Or how much time we'll waste..."
            mc "But since we're doing this, why don't we just use one copy?"
            ...
            n "Whatever, we're both new at this anyway."
            n "Let's just try it."
            ...
            "I didn't expect this to work but I actually really enjoyed it."
            "Before too long, we finish the first volume of manga."
            n "That was...better than I thought it would be."
            mc "Yeah, it turned out pretty well."
            mc "I'm glad we did that."
            mc "Your impressions were..."
            n "They were amazing, just say it."
            mc "Sure..."
            "I say that sarcastically."
            n "You should put more effort into yours though."
            ...
            n "We shouldn't waste more time than we need to."
            mc "That's right."
        ...
        n "We can read it together, if you want to."
    ...
    if ch14_overall_choice == "Sayori":
        ...
        mc "I think it's good that they're trying to make do with what they've got."
        mc "It gives a hopeful feeling in me for them."
        n "That's true, I suppose."
        n "But doesn't it seem kinda fake to you?"
        mc "What do you mean?"
        n "Don't you think people in that sort of situation would be acting differently?"
        n "I'm...speaking from experience."
        ...
        mc "That would make sense."
        mc "I still think they're going to get what they were looking for."
        n "That sounds like wishful thinking."
        mc "I guess I just I want them to get a happy ending."
        ...
        if monika_type == 0 or (monika_type == 1 and ch12_markov_agree):
            ...
            mc "How come?"
            n "I don't know much about horror stories."
            n "But most of them are just fiction, right?"
            n "I'd rather not be living one."
            mc "I see..."
            n "I just hope the story starts changing soon."
            n "And that it is just a coincidence."
            mc "Yeah, probably..."
            mc "Anyway, what do you think the message was behind this?"
            n "I...don't really know."
            n "Despite the coincidences, the book was still pretty boring."
            mc "How is it boring?"
            n "Nothing exciting is happening."
        ...
        mc "I think it's pretty interesting, actually."
        mc "It's just strange to me how a radio could cause all of that."
        n "You think the radio is the cause?"
        n "I didn't really get that idea."
        mc "Go on..."
        n "I think the supernatural stuff was already there."
        ...
        mc "Solve a puzzle or be trapped in a loop forever."
        mc "I wonder why she's the only one who can realize."
        n "I'm sure there's probably a reason."
        ...
        mc "Well, I probably have a biased opinion."
        mc "Seeing as it's the book I brought."
        n "Maybe, but I'd still like to hear your thoughts."
        ...
        mc "I can still relate to the main character."
        mc "How he's so ordinary."
        n "You really think you're ordinary?"
        if yuri_date:
            n "I'd say you're more than ordinary."
            n "You've done things for me that no ordinary person would do."
            n "So no matter how you see yourself..."
            n "You're more than that, okay?"
            mc "Thanks, Natsuki."
            ...
            n "That's just a matter of perspective."
            mc "What do you mean?"
        ...
        mc "Would he be a force for good or use it for his own selfish means?"
        mc "It kinda makes me question what I'd do in the same situation."
        n "So? What would you do?"
        mc "Honestly, I'm not sure."
        mc "I don't know if I'd actually be responsible with that kind of power."
        n "I guess we don't really know ourselves until we're faced with a situation like that."
        mc "That's surprisingly philosophical of you."
        n "I can be philosophical if I need to be."
        mc "In any case, you're right."
        n "What would you say is the message behind this though?"
        ...
        n "Ordinary...?"
        n "I guess that makes sense."
    n "Hmm...that gives me an idea..."
    mc "What kind of idea...?"
    n "An idea for the second thing on my list."
    n "Baking."
    mc "Already?"
    ...
    n "Then after that, we can try baking them and using the icing to make the design."
    "She sits down, gets a pencil and begins to sketch some designs."
    n "Well, are you going to help?"
    if natsuki_date:
        mc "Just a second..."
    ...
    if ch12_outcome == 1:
        ...
        n "My dad used to cook this whenever I was feeling sad."
        ...
        n "I-I don't know."
        n "Maybe he's upstairs now?"
        n "But he's finished with the kitchen, so we can go there when we're done here."
        ...
        n "It's the cake that mom always used to..."
        n "U-Used to..."
        ...
        n "I-I don't know."
        n "Maybe they're upstairs or doing some yardwork."
        n "But it looks like they're finished with the kitchen."
        n "Which means we can go there after we come up with a design."
    ...
    n "Hopefully we can decide on something."
    n "We have quite a bit of time."
    n "So maybe we can come up with some stuff for tomorrow too."
    mc "That sounds like a good plan."
    n "After we come up with a design, you can leave if you want."
    n "Or you can stay."
    ...
    n "No matter what you're doing, you should come up with designs when you get home."
    ...
    if natsuki_date:
        ...
        n "Y-Yeah, we did."
    n "Anyway, make sure you come up with designs for tomorrow."
    ...
    n "I'll bring some ingredients tomorrow so we can test out some of the designs for the things that are cook quicker."
    n "To see if they work and look good."
    mc "That makes sense."
    mc "When were you planning this?"
    n "Maybe we could spend some time during lunch?"
    n "These things won't take long to cook."
    n "We're just gonna test out the designs."
    mc "Alright, just tell me where."
    n "I'll send you a text when I can."
    n "But there is a nice spot I know."
    mc "Hopefully I can be more helpful tomorrow than I was today."
    n "You were helpful, [player]."
    n "I'm really glad you decided to help me, you know."
    mc "I'm happy to have helped."
    "Natsuki starts packing up the things she brought down here."
    n "You can get your things upstairs, if you want."
