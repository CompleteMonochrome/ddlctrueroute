...
label ch14_exclusive_yuri:
    ...
    s "You two have fun!"
    show sayori zorder 2 at t21
    "Sayori starts walking away, in the direction of her house."
    "She turns back and smiles at us."
    ...
    if ch14_overall_choice == player:
        ...
        if ch14_overall_choice == "Sayori":
            y "Sayori did make sure to give everyone a copy..."
            ...
            y "We all borrowed a copy from the library"
    return
