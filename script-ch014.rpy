...
label ch14_exclusive_yuri:
    ...
    y "A-Are you okay?"
    y "I don't want to force you to get out of bed if you're not feeling well."
    ...
    y "Is everything to be okay?"
    mc "What do you mean?"
    y "Our preparations..."
    y "...And everyone else's."
    y "Do you think everything will be okay?"
    mc "I don't doubt the others, Yuri."
    y "I-I don't doubt them either!"
    y "Under normal circumstances..."
    y "But everything feels out of place."
    mc "Out of place?"
    "I turn towards Yuri."
    mc "What do you mean?"
    y "Doesn't it feel like we've been living under some kind of lie?"
    y "That this whole thing is just a set up?"
    mc "Yuri..."
    y "[player], you told me to speak my mind..."
    y "And there's been a lot of things on my mind."
    if yuri_date:
        y "Lot's of things that feel like fake memories."
        mc "Fake memories?"
        y "I wasn't really questioning it before..."
        y "But when you woke up and started wondering where you were..."
        y "I thought it was a little strange."
        y "Then...I thought it about it a bit more."
        mc "What did you figure out?"
        y "I have really vague memories."
        ...
        y "It's...I don't know how to say it."
        mc "Take your time."
        y "..."
        y "D-Do you ever feel like..."
        y "Ah...this is too absurd."
        mc "Yuri, you can tell me."
        y "I don't know it just feels like sometimes I'm not in control of myself."
    ...
    y "We probably have time to buy them but I'm not sure if we'll be able to start creating some."
    mc "I see..."
    ...
    y "We don't have to go out, you know..."
    ...
    y "And we should probably look at the book we voted for in the club too."
    mc "That too..."
    ...
    y "Now, where did we put that list?"
    ...
    show yuri 1ba zorder 2 at t11
    y "What is this?"
    y "It's like all the stuff from our list..."
    show sayori 1ba zorder 3 at hf21
    s "Surprise!"
    ...
    s "You guys don't owe me anything."
    ...
    show sayori zorder 3 at f21
    s "Oh...it's um..."
    s "I was just kidding in the first week..."
    s "Y-Yeah, that's it!"
    s "I had enough money..."
    ...
    s "It's nothing."
    s "Anyway, I need to go..."
    s "I still have a script to write after all."
    s "I'll just leave the wheelbarrow there."
    ...
    s "Good luck with your preparations."
    show sayori at thide
    hide sayori
    show yuri zorder 2 at t11
    mc "Goodbye, Sayori."
    y "This is so strange..."
    mc "I know..."
    ...
    y "We should start taking some of this stuff inside, right?"
    mc "Good idea."
    scene bg bedroom
    show yuri 1ba zorder 2 at t11
    with wipeleft_scene
    ...
    y "Have you got a design in mind?"
    ...
    y "I'm sure we'll still have time to do the banner."
    if ch14_overall_choice == player:
        ...
        y "Now that I think about it, I'm having doubts we actually went to the library..."
        y "But it does make sense since this is a loan copy."
        y "I'm surprised but they had enough for the rest of us."
    elif ch14_overall_choice == "Yuri":
        ...
        y "You don't remember borrowing it from the library after the meeting?"
        ...
        if ch14_overall_choice == "Sayori":
            ...
            y "It's quite out of character for her to be that organized."
            y "But thinking about it...I can't really recall when she gave everyone a copy..."
            y "I suppose it doesn't matter."
            ...
            y "I'm surprised she had that many copies but I'm not complaining."
            y "I just can't remember when exactly she gave us a copy."
            y "It doesn't really matter though."
        else:
            y "We all borrowed a copy from the library, remember?"
            if ch14_overall_choice == "Natsuki":
                y "Along with the next couple of volumes."
            y "I just...can't really remember going there."
    ...
    if ch14_overall_choice == player or ch14_overall_choice == "Natsuki":
        ...
        y "I see..."
        if yuri_date:
            y "Well...I am willing to try if you are."
            ...
            y "Then I suppose we should read separately."
            y "We have to do our preparations afterwards anyway."
            y "We should use our time effectively."
            ...
            y "Have you finished reading, [player]?"
            mc "Just about done, yeah."
    else:
        y "I suppose we could read it together."
        y "T-That is, if you want to."
        ...
        if ch14_overall_choice == "Yuri":
            y "I think I've remembered most of the important things now."
        else:
            y "Okay, I think I know enough about it."
        y "At least, from what I've read."
        y "What about you?"
        mc "I think I've got it."
        mc "The important parts, at least."
    y "Let's talk about it a bit."
    ...
    if ch14_overall_choice == "Sayori":
        ...
        mc "What do you mean?"
        y "Do you really think people in such a situation would be like that?"
        ...
        y "Then I presume it's only going to get darker."
        ...
        y "It's a matter of perspective, but yes."
        ...
        if monika_type == 0 or (monika_type == 1 and ch12_markov_agree):
            ...
            y "I can sense it too."
            y "It's not exactly something I'm accustomed to."
            y "But it's the thing Monika is into."
            y "I suppose we all have different tastes."
            mc "There's nothing wrong with that."
            y "I know, I'm just saying this isn't something I would voluntarily read."
            mc "Right..."
            y "I can sort of sympathise with her."
            ...
            y "I think that's why Monika likes the story."
            mc "What do you mean?"
            ...
            y "I could be wrong..."
            if yuri_date:
                y "But don't worry, you're perfect to me, [player]."
            ...
            mc "In the book."
            y "I suppose it could be a coincidence..."
            mc "It might be."
            ...
            mc "Why not?"
            y "There's a difference between reading horror stories and actually living one."
            ...
            mc "Bland?"
            y "Despite those coincidences, nothing is really happening."
        ...
        y "The radio isn't the cause, [player]."
        y "It's more like a catalyst."
        y "The supernatural stuff was already there..."
        ...
        y "It is quite uplifting, isn't it?"
        y "It seems like there's going to be conflict in future volumes though."
        ...
        y "It's quite similar to analyzing a normal novel."
        ...
        y "For instance, every time that daughter was shown..."
        y "She was shown to have an envious face."
        mc "I noticed that too."
        y "I wonder when it will get to the predicting the future."
        ...
        y "So you think a banner depicting happiness is appropriate?"
        ...
        y "I'd still like to hear what you think."
        y "You haven't read this volume in a while, right?"
        y "What did you think when you were read it again?"
        mc "I can still relate to the main character."
        mc "How he's so ordinary."
        y "You think you're ordinary?"
        if yuri_date:
            y "You're definitely more than ordinary, [player]."
            y "No matter how you see yourself."
            y "You're perfect, to me."
            mc "Thanks, Yuri."
            mc "That means a lot."
            mc "You're perfect to me as well."
        else:
            y "I guess it's a matter of perspective..."
            mc "What do you mean?"
            y "To others you aren't ordinary..."
            y "Y-You're..."
            mc "What?"
            y "N-Nevermind, [player]."
    ...
    y "I'm actually surprised it's getting this late."
    mc "With all that's happened, it makes sense."
    mc "But it feels like the day has gone by so quickly."
    y "You're not wrong..."
    y "I have an idea."
    mc "What is it?"
    y "Why don't we take the rest of the night off?"
    y "We can come up with ideas for the banner tomorrow."
    y "I'll bring the necessary materials to school."
...
label ch14_exclusive_monika:
    ...
    if monika_type == 0:
        ...
        m "I don't know what they'll do with that information."
        m "But I hope..."
        mc "The danger?"
        mc "You told someone?"
        m "..."
        ...
        m "With it gone, my mind should be so much more clear."
        m "But right now, it's just a complete mess."
        m "I don't know how to fix it."
        m "That's why I told her."
        mc "Her?"
        mc "Who are you talking--"
        m "I've said too much."
        ...
        mc "Hope?"
        mc "For what?"
        m "That next week is...something we can both enjoy."
        mc "...Right."
        m "I need to know how close we are to breaking."
        ...
        mc "What do you mean?"
        m "Can you just turn around for a few seconds?"
        mc "Turn around?"
        mc "Why?"
        m "You ask a lot of questions, [player]."
        "Monika sighs."
        m "You just need to trust me."
        m "You'll understand, okay?"
        ...
        m "Sometimes, Sayori is listening."
        m "Other times, [player] hears the conversation."
        m "I hate to hurt him but..."
        m "What other way is there?"
        m "I can't just make him fall asleep."
        m "..."
        m "I told Sayori."
        m "Not everything."
        m "I needed to know how she'd take it."
        m "I know, it's selfish of me."
        m "I should just be able to take whatever she has to say."
        ...
        menu:
            ...
            "Yes." if not ch14_m_ask:
                if persistent.markov_agreed:
                    ...
                    m "I should tell her."
                    m "I've been keeping this secret for so long."
                    m "And for what?"
                    m "What has been stopping me from telling her?"
                    m "Nothing."
                    m "Just...me."
                    m "I knew I should have told her..."
                    m "I just wanted to hear you say it."
                    m "I know that sounds stupid."
                    m "You just mean so much to me."
                    m "You give me clarity when my mind is clouded..."
            "No.":
                $ ch14_m_tellsayori = False
                m "I...shouldn't?"
                m "O-Okay."
                ...
                m "I'm sorry for bothering you like this."
                m "I just had to speak to someone."
                m "Someone real..."
                m "With my mind all clouded, I suppose you're my only clarity."
                m "So you must know what you're talking about."
        m "You know..."
        m "Sayori is a lot better than me in a lot of ways."
        m "She can do things I never even thought of."
        ...
        m "They were just shells of themselves."
        m "And she told them that the meeting was over."
        m "I wasn't affected, I don't know why."
        m "Maybe it's because I was the president before..."
        m "She was going to make me like that too."
        m "But I pleaded with her not to."
        m "I didn't want to feel out of control of myself."
        m "More than I already do."
        m "And she listened."
        m "I'm so lucky that she's our president, [player]."
        m "That she's...my friend."
        m "She told me that she would just make it seem like nothing happened."
        m "So everyone would just think the meeting ended normally."
        m "That's good...I think."
        m "But at the same time, I'm...jealous."
        ...
        m "The one that was chosen in the meeting today."
        m "But thank you."
        m "For listening to me."
        m "For just...being real, being you."
        m "You don't know just how much that means to me..."
        show monika at thide
        hide monika
        $ pause(3.0)
        scene m_livingroom
        ...
        m "Are you sure?"
        mc "Y-Yeah..."
        m "Then I wanted to talk about the book the club chose."
    elif monika_type == 1 and ch12_markov_agree:
        ...
        m "Excellent!"
        m "You hear that?"
        m "Our plan is all coming together!"
        m "Just how much did you read, [player]?"
        m "Enough...right?"
        $ style.say_dialogue = style.edited
        mc "I'm not sure..."
        ...
        m "To think, that her own best friend would ruin her life."
        ...
        m "At least right now when I'm using my powers on you."
        m "Or maybe..."
        m "Yes, that's probably it."
        m "I'm using Monika's powers on you right now."
        m "And not my own."
        m "So you still have some semblence of free will."
        m "A very little part of you exists in your current state."
        m "But I suppose that's enough for you to want to ask questions."
        m "Ahaha."
        ...
        $ style.say_dialogue = style.normal
        m "That's two questions, [player]."
        m "But I'll answer them anyway."
        m "Not like you can actually do anything with the knowledge."
        m "The book works because a part of me is stored inside it."
        m "I told you that yesterday."
        m "That part of me is a piece of my soul."
        m "When someone reads the book, I get into their head."
        m "I rewrite their common sense and change them."
        m "To an extent, I can control what they do."
        m "Basically, I change their code without them realizing it."
        m "When the book is fully read, they turn into my puppet."
        m "Not literally, but they'll do anything and everything I say."
        m "It's quite horrifying actually!"
        m "Now that I think about it..."
        m "I think Monika actually had the power to do that herself."
        m "At least to some extent."
        m "She was even experimenting with Sayori."
        m "She wanted you so bad, you know?"
        m "That's why she almost..."
        $ style.say_dialogue = style.edited
        "Monika smiles menacingly."
        $ style.say_dialogue = style.normal
        m "Ahaha, if she died back then none of this would have ever happened."
        m "So in a way, I guess I'm glad she's alive."
        m "I'll have everything I ever wanted and more."
        m "Now, that answers both your questions, doesn't it?"
        m "Or is there something else?"
        m "I'm sure {i}you're{/i} probably curious about some things as well."
        m "But I can't exactly put up a question for you to ask..."
        ...
        m "You have a chance to ask questions as yourself."
        m "So go ahead."
        mc "I..."
        mc "What is this?"
        mc "What was I...?"
        m "Slowly, [player]. Slowly."
        m "Why don't you breathe in and out?"
        $ style.say_dialogue = style.edited
        mc "Right away."
        "I take a deep breath and exhale."
        $ style.say_dialogue = style.normal
        m "Not like that!"
        m "I'm trying to exert a bit of power on him but also giving him somewhat free thought."
        ...
        "My own free will..."
        m "Just hurry it up, okay?"
        "She can read my thoughts?"
        m "Yes, now get on with it."
        "What should I ask?"
        ...
        m "My connection to the real world."
        m "If it weren't for that I'd have no interest in you at all."
        mc "..."
        m "What a terrible question."
        m "Next."
        mc "What exactly are you?"
        m "What am I?"
        m "I'm either your worst nightmare or your best friend."
        m "Depends how you look at it really."
        m "Your questions are boring, [player]."
        m "I might just shut you off again."
        mc "No! P-Please, Monika."
        mc "I know you're in there..."
        m "Ahaha, I'm not Monika."
        m "You should know by now she's gone."
        m "Forever."
        m "Any chance you had of bringing the real her back..."
        ...
        "Maybe..."
        m "Do you honestly think Sayori would believe you?"
        m "You won't even get to tell her the chance."
        m "And do you know why?"
        mc "..."
        m "Because you're already my tool."
        m "{i}Our{/i} tool."
        m "There's nothing you can do."
        m "The only reason you even have free thought right now is because I'm allowing it."
        m "Do you understand?"
        mc "No!"
        mc "I don't understand any of this!"
        m "I don't suppose you would."
        ...
        m "But having suicidal thoughts was a part of her that she never seriously considered."
        m "She cared too much about what would happen to the people around her."
        m "She would never try something as stupid as that..."
        m "Until Monika pushed her."
        mc "W-What?!"
        mc "W-What do you mean you pushed her?"
        m "Monika just gave her a little nudge in the right direction."
        mc "No...that's not...you wouldn't..."
        m "I'm not Monika."
        m "I wasn't the one who gave her that push."
        m "But given the circumstances, I would have done the same thing."
        mc "You're lying...there's no way Monika would..."
        m "Why would I lie about something so trivial?"
        mc "Y-You..."
        m "That's right."
        m "Do you hate me?"
        mc "B-But Monika, she..."
        mc "S-She helped her!"
        m "And why do you think she helped her?"
        m "You don't think she really cares about Sayori, do you?"
        m "Let me spell it out for you."
        m "I made Sayori want to kill herself."
        m "And I have no regrets."
        m "Except that I chose to help her."
        "That voice..."
        "It's Monika's..."
        ...
        m "I'll just supress those memories, you know, just in case."
        mc "Don't do it."
        mc "Please."
        mc "I can't bear to lose my memories again."
        m "Ahaha, you're so pathetic."
        m "You hold no power over me."
        m "I feel nothing for you, [player]."
        m "Do you hear me?"
    ...
    if ch14_overall_choice == "Monika":
        ...
        if monika_type == 0 or (ch12_markov_agree and monika_type == 1):
            ...
            m "Actually, you have a copy of it in your bag."
            mc "I do...?"
            m "Yeah! Why don't you check your bag?"
            ...
            m "I know we didn't get to read all of it..."
            ...
            mc "Am I wrong?"
            m "That's...pretty analytical of you, [player]!"
            m "You're right though."
            m "There is going to be something but you'll have to read more to find out what it is."
            ...
            m "You could say I had a feeling."
            ...
            m "Oh, who knows what it could be?"
            m "It could be anything!"
            m "Maybe you hit your head too hard."
            "Monika smiles."
            mc "It's possible..."
            m "Maybe you've just forgotten."
            mc "That's probably it."
            m "Or maybe someone has been tampering with your memories."
            mc "What?"
            m "Just kidding!"
            m "Who could do that anyway?"
            m "It's not like someone just has the ability to just make you forget."
            mc "...Yeah."
            m "Anyway, why don't I show you why I chose this book by reading it to you."
            mc "Reading it to me?"
            m "Yeah, that way we won't miss any details."
            ...
            m "You've got that look on your face."
            mc "What look...?"
            m "The look of \"what's going on?\"..."
        ...
        m "Though obviously I would have preferred to do my book."
        mc "Sorry about that."
        mc "I guess I just had more interest in this one."
        m "It doesn't matter."
        m "It's all going to end up the same anyway!"
        mc "I guess you're right."
        "Monika pulls out a copy of the book we voted for in the meeting."
        m "So, should we read it?"
        m "That way I can get a better idea of what happens."
        if ch14_overall_choice == player:
            m "It's your book, so you must have some reason for liking it."
            ...
            m "Ah, you don't need to do that."
            ...
            mc "No? What happened?"
            m "We all went to the library after the meeting."
            m "Then we each borrowed the manga."
            m "Luckily, they had enough copies."
            mc "The school library had four extra copies of my book?"
            m "Apparently, they also had copies of the next couple of volumes."
            ...
            if monika_type == 0:
                m "It's...not bad."
                m "I was expecting a lot less, I'll be honest."
                m "But I was pleasantly surprised."
                mc "I'm glad you liked it."
                m "I can see why you chose it."
                m "The main character definitely has some similarities to you."
                mc "Yeah, I thought so too."
                m "This phone thing seems pretty interesting."
                m "Being able to set events in motion like that..."
            else:
                m "It's...different."
                m "I don't exactly read mangas, [player]."
                m "So I don't really know how to evaluate one properly."
                mc "I see..."
                m "That said, I am kind of interested to see where the story goes."
            ...
            m "That would make sense."
        else:
            m "And it could be beneficial to the both of us."
            m "Seeing as neither of us have really read it."
            m "Or know much about it, right?"
            mc "I guess so."
            ...
            if ch14_overall_choice == "Natsuki":
                ...
                m "We actually do have a copy of the first four."
            else:
                m "We don't have a copy, right?"
                mc "You read my mind."
                "Monika smiles nervously."
                m "We actually do have a copy."
            if ch14_overall_choice != "Sayori":
                m "Don't you remember Sayori giving you a copy?"
                mc "She did?"
                mc "I don't remember that happening at all."
                m "It's true."
                m "Why don't you check your bag?"
                m "I'm sure it's in there."
                m "I know I have mine."
            else:
                if ch14_overall_choice == "Natsuki":
                    m "Don't you remember borrowing them?"
                    mc "Borrowing them?"
                else:
                    m "Don't you remember borrowing it?"
                    mc "Borrowing it?"
                mc "As in, from the school library?"
                m "Yeah."
                m "We all went there after the meeting."
                m "Luckily, the library had enough copies."
                mc "That's a relief."
            ...
            if ch14_overall_choice == "Natsuki" or monika_type == 2:
                ...
                m "I can take it all in easier, you know?"
                mc "Ah...I see."
                mc "I guess that makes sense."
                m "I hope you're okay with that."
                m "I want to understand the story."
                m "And it would be kinda difficult if we did it together."
                ...
                m "I suppose that isn't the worst idea you've had."
                m "Do you want to start it off?"
            ...
            m "The story certainly feels like it's getting somewhere."
            if ch14_overall_choice == "Yuri":
                m "Especially with this whole radio thing."
                m "Who would have expected a radio to cause all of that?"
                mc "I know, it's weird."
                mc "I'm not sure exactly how that radio thing works."
                m "I think the radio is perfectly normal."
                ...
                m "The radio had nothing to do with that."
                mc "You're right."
                m "This time travel aspect is strange though."
                m "They keep going backwards until they solve a puzzle."
                ...
                mc "How come?"
                m "Well, I doubt the others would have the ability to beat the time loops."
                m "It only seems to be her that can."
                mc "Ah, you're right."
                mc "I didn't think of it like that."
            elif ch14_overall_choice == "Natsuki":
                m "This alien person is going to start having a bad time soon."
                m "At least, that's the feeling I'm getting."
                if monika_type == 0:
                    m "Life can't be all sunshines and rainbows after all."
                else:
                    m "Life can't be all death and bloodshed after all."
                    $ del _history_list[-1:]
                    mc "W-What?"
                    m "I said life can't be all sunshines and rainbows..."
                    mc "Right..."
                ...
                m "I'm sure the author will find a way."
                ...
                m "I'm just curious to see what he'll do with it."
                mc "Yeah, me too."
            else:
                m "The bleakness of it makes me feel like it's going to be some sort of emotional journey."
                ...
                m "Making the most out of any situation, eh?"
