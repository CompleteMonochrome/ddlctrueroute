...
label ch14_end:
    ...
    if monika_type == 0:
        ...
        "She replaces the book in her hands with the second one she brought."
        ...
        m 1e "It's probably the book that's closest to my heart, which is fitting given its name."
    ...
    if ch13_name == "Yuri":
        ...
        if ch13_natsuki_books:
            ...
            "The novel I chose isn't some kind of book that is special to me or anything."
    ...
    # One Novel Three Manga
        ...
        mc "In their world, the sport is a real thing with its own rules and stuff like that."
    ...
    # Two Novels Two Manga
        ...
        if ch13_name == "Yuri" and ch13_yuri_books:
            ...
            mc "From the student's perspective, it seems more like a horror."
            ...
            y "But I suppose I'm a little bit biased since I'm the one who gave the book to [player_reflexive]."
            show yuri zorder 2 at t43
            mc "Ah...yeah."
    ...
    s "But think of the worst case scenario."
    ...
    if monika_type == 0:
        ...
        m "I think there are a couple of ways we could deal with that."
    ...
    n 2a "Which makes us want to believe you."
    ...
    if monika_type == 0:
        ...
        if monika_type == 1:
            ...
            m "What matters is that you're trying your best as the president of this club."
...
label ch14_exclusive_yuri:
    ...
    if yuri_date:
        y 3bv "Lots of things that feel like fake memories."
        mc "Fake memories?"
        ...
        y "Then...I thought about it a bit more."
    ...
    if ch14_overall_choice == "Sayori":
        ...
        mc "I guess I just want them to get a happy ending."
        ...
        mc "There were times when I was just smiling at how wholesome it was."
        ...
        y "I see..."
        y 3bg "I guess we can't actually know who we truly are until we get that kind of power..."
        mc "I guess so."
        y "I don't really know how to make a banner out of this though..."
...
label ch14_exclusive_natsuki:
    ...
    if natsuki_date:
        ...
        if ch12_outcome == 3:
            ...
            "I stand at the entrance to the room from where Natsuki's parents are."
            ...
            mo "It's as if the very fabric is in its original state."
            ...
            mc "Yeah, I just wasn't expecting that."
            mc "And I didn't really expect to be part of your family hug either."
            mc "You two looked like you were having a really strong moment, you know?"
            mc "That kind that lasts forever in your memory."
            n 1bt "W-Well, you know..."
            n "Um..."
            "Natsuki's voice becomes weak as her face becomes bright red."
    ...
    if ch14_overall_choice == player or ch14_overall_choice == "Natsuki":
        ...
        n "I think I got what's enough out of that."
...
label ch14_exclusive_sayori:
    ...
    mc "I'm sure of it."
    s 1bk "I...don't know."
    mc "Clearly being the president of a club has had its toll on you, Sayori."
