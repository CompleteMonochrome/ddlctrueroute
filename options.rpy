...
define config.name = "Doki Doki True Route!"
...
define config.version = "0.9.5CHRISTMAS"
...
define config.save_directory = "DDLCMonikaRoute"
...
init python:
    ...
    # bulld.archive("mod_assets", "all")

    # build.classify("game/mod_assets/**.jpg", "mod_assets")
    # build.classify("game/mod_assets/**.png", "mod_assets")
