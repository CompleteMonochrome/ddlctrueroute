label ch11_main:
    ...
    s 1bc "I have to wonder why [player] was asking me about [player_reflexive] though..."
    s "Why would [player_personal] ask me something like that?"
    s 1bj "Did you make [player_reflexive] do that?"
    s "..."
    s 1bk "No, I don't think you did."
    s "I would have known if you actually had a choice..."
    s 1bh "Is [player_personal] just becoming more aware of what's going on?"
    ...
    if m_appeal == 3 and did_all_tasks:
        ...
        s "I got her to follow him as he was heading home from the store."
        s 1bc "She said she didn't find anything interesting and I believe her but..."
        s "...I don't know, there was something about her that seemed off."
        s "It was just for a moment but it's like she wasn't her regular self."
        s "Maybe she was just tired after a long day."
        s "After all, she was quite busy all day yesterday."
        s "I'm probably overthinking this. I trust Monika to do the right thing."
        s 1bb "Anyway..."
    else:
    ...
    s "...well, then [player_personal] might get suspicious."
    ...
    if check_whole_house:
        ...
        s 1bh "[cPlayer_personal]'s going to find out about it again anyway..."
    ...
    if visited_yuri_hospital:
        s 1bm "Wait a second..."
        s "I forgot."
        s "[player] is doing something with Yuri today, isn't [player_personal]?"
        s 1bn "You probably never saw it..."
        s "But they made some plans to go somewhere after [player_possessive] visit to the hospital."
        s "I didn't even remember about it until now."
        if yuri_date:
            s 1bl "I think you might have remembered Yuri giving a hint after [player_possessive] date..."
            s "Or maybe not..."
    ...
    if visited_yuri_hospital:
        ...
        "Clerk" "\"Hey, kid.\""
        mc "Yeah?"
        "Clerk" "\"You're a pretty lucky [player_casual].\""
        mc "How so?"
...
label ch11_end:
    ...
    d 1b "And you work as a delivery [player_gender]?"
    ...
    n "N-No..."
    n "Of course, I don't know [player_reflexive]..."
    n 2bs "Why would I?"
    show natsuki zorder 2 at t21
    show dadsuki 1e zorder 3 at f22
    d "What you said sounded like a name."
    d "It doesn't matter."
    d 1g "[cPlayer_personal] says [player_personal] can only deliver this manga to you specifically."
    ...
    if m_appeal == 3 and did_all_tasks:
        ...
        menu:
            ...
            "Yes.":
                ...
                m 1bn "I really didn't think that {i}you{/i} would make [player_reflexive]..."
                mc "Make who...?"
                m 1bm "Nothing..."
        ...
        if sayori_confess and not sayori_dumped:
            ...
            mc "Maybe not as your [player_gender]friend, but always as a friend."
        s 1bk "..."
...
label ch11_dinner:
    ...
    m "I don't want her to have more to deal with because of some mistake I did."
    m "If only I was better, I wouldn't be in this mess."
    mc "What happened, Monika?"
    m "Yesterday, I did something I shouldn't have. Saw something I shouldn't have."
    m "I had a bad feeling about it but it was something that needed to be done..."
    m "Sometimes things don't always work out the way you intend them to."
    mc "You can tell me anything, you know."
    mc "What's this mistake you did? What did you see?"
    m "I can't tell you what I saw, [player]. I'm sorry."
    m "There's a reeason for that, and I can't tell you that too."
    mc "All of this sounds so weird...but I trust you must have a good reason for it."
    m "Since I saw it, it's as if there's some lingering {i}thing{/i} in my head."
    m "I just don't know what to do."
    mc "Well, what were you doing?"
    m "I can't say. I will say I was doing it for Sayori but..."
    mc "I'm sure Sayori is happier with you helping her, Monika."
    mc "But does her being happy come at the cost of your happiness?"
    mc "That isn't fair..."
    mc "Especially if it's something that's affected you like this."
    ...
    m "Especially with what I saw yesterday."
    "Monika turns away."
    ...
    "What did Monika see yesterday that's got her so worried?"
    "I wish I wasn't so helpless..."
    "I just wish she'd reach out for help from me, Sayori or anyone else."
    "There must be some reason she can't tell me what it was but..."
