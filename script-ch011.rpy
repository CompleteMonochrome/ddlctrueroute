label ch11_main:
    ...
    if check_whole_house:
        ...
        s 1bd "Ehehe..."
        s "I really could have done better, right?"
        s "..."
        s 1bk "I feel kinda guilty but I deleted the closet in Natsuki's house from [player]'s memory."
        ...
        s "His wife, I think her name was {i}Yuu{/i} or something..."
        s "She left him..."
...
label ch11_end:
    ...
    d "I'm going to go back to watch TV."
    ...
    if check_whole_house:
        ...
        n "I couldn't sleep..."
        n 12bi "There was bottles of alcohol being thrown everywhere and lots of yelling from mom and dad."
        ...
        n "And we waited..."
        n "A day...a week..."
        n 12bh "Dad even tried calling her and her friends to try and find out where she went."
    ...
    "I guess that's to be expected to try and sell more copies of the series."
...
label ch11_dinner:
    ...
    mc "I guess you add stock to it first then a tiny bit of oil?"
    ...
    m 2bc "That's..."
    m 2ba "Some good planning on your part, I guess."
    mc "Thanks..."
    ...
    "I managed to include some spicy mushrooms in it to try and give the tofu some flavor."
    ...
    mc "Has no on ever invited you to dinner like this?"
    m 1be "It's not that..."
    ...
    m "I guess you've surpassed my expectations."
    ...
    mc "It kinda made me think about Sayori..."
    ...
    m "Just imagine living your life one day and the next your whole world turning upside down."
    ...
    mc "You're right."
    mc "I guess I'm just a little shaken."
    ...
    menu:
        ...
        "Read Sweet Oppression.":
            ...
            "I guess it's time to get started on the last two chapters."
            "..."
            "I didn't really notice it before but the art is actually really good."
            "It's like a good mix of realism and manga..."
            "The story also got pretty interesting."
