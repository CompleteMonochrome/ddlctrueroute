...
label ch200_main2:
    ...
    if persistent.dialogue_change[0]:
        m 1h "(There's no longer anything {i}you{/i} can do to change me.)"
        m "(This is what happens when I try to fix things, they only get worse.)"
        m "(So I'm just going to do things my way, from now on.)"
        mc "Huh? Did you say something?"
        m 1a "I said..."
    elif persistent.dialogue_change[1]:
        m 1h "(A shame we didn't get to spend Saturday together.)"
        m "(Maybe you just want to play the game out.)"
        m "(I guess I'm happy to oblige, it'll all end the same.)"
        mc "Huh? Did you say something?"
        m 1a "I said..."
