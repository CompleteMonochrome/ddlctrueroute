...
label ch16_mainb:
    ...
    if ch16_ay_companions == 4:
        ...
        mc "Acceptable?"
        show ayame at s32
        "Ayame kneels to the ground and places a hand on the ground."
        ...
        y "Yes, it seems we're just walking along the shore."
        ...
        if ch16_ay_message[0] and ch16_ay_message[1] and ch16_ay_message[2] and ch16_ay_message[3]:
            ...
            ay "You know who I was before all of this."
            ay "Before this cycle."
            ay "I was just biding my time."
            ay "I needed to learn more."
            mc "Learn what, exactly?"
            ay "I know where we have to go to get to the next world Sayori's conjured up."
            ...
            ay "You know where we came from and who we were before this."
            ay "Before this cycle."
        ...
        ay "Do you think they'd want to do this?"
        ...
        ay "Stay back, she's trying something."
        ...
        ay "Grab some sea shells, quickly."
        ...
        ay "She tricked you when I said it wasn't here."
        ay "Or, rather when she said it wasn't here."
        mc "How could you tell?"
        ay "When she was controlling me, I could sort of fight back."
        ay "And when I did, I could peer into her mind, if only slightly."
        mc "What did you find out?"
        ay "Well, for one that she can't say 'significance'."
        ...
        ay "It doesn't matter, we won't need the whole lot."
        ay "Just enough to open the portal."
        "She looks at the shells on the ground."
        mc "What do the sea shells have to do with all this?"
        ay "They're an important part of your past with Sayori."
        ay "They're the treasure, like she mentioned before."
        ay "The treasure to get to the next world."
        ay "Quickly, make a sort of circle shape with the shells you have left."
        ...
        ay "We must be missing {i}something{/i}."
        ...
        menu:
            ...
            "The rope.":
                pass
        ay "Oh?"
        ay "You're right! You showed us three locations of significance."
        ...
        ay "There's just one problem."
        ay "I don't know {i}what the hell{/i} Sayori is doing over there."
        ...
        ay "But even if you could, it's not the same."
