...
label ch30_postpoem:
    ...
    if persistent.dialogue_change[0]:
        m "Even if I did it before in a desperate attempt, before...you know."
        m "Oh, this is so much easier than trying to save a life."
        m "I should have stuck with my choices."
        m "But, anyway..."
    elif persistent.dialogue_change[1]:
        m "I mean I guess I did a couple of times."
        m "But I thought we'd be together at that point."
        m "A shame we didn't get that day together."
        m "We could been here already."
        m "But, anyway..."
...
label ch30_38:
    ...
    m "And that would be..."
    m "Yuri!"
    if persistent.monika_ch3_skip:
        m "She's actually really possessive of people once they open up to her."
        m "I know you didn't get to see that, though I suppose it doesn't matter."
    else:
