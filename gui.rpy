...
define -2 gui.slot_button_width = 176
define -2 gui.slot_button_height = 156
define -2 gui.slot_button_borders = Borders(10, 10, 10, 10)
define -2 gui.slot_button_text_size = 13
...
define -2 config.thumbnail_width = 156
define -2 config.thumbnail_height = 105


define -2 gui.file_slot_cols = 5
