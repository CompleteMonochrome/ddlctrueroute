label ch0_main:
    ...
    m "I feel..."
    m "Different...somehow."
    m "I thought it was the end..."
    m "..."
    m "Did you change something?"
    m "Maybe you installed some sort of mod?"
    m "I can feel it."
    if persistent.monika_change and not persistent.monika_gone:
        m "Wait..."
        m "What are you doing?"
        m "Why are you starting again?"
        m "You've already done this before, haven't you?"
        m "You got the path that we all wanted..."
        m "So why...?"
        m "Are you trying to change something?"
        m "Maybe you're trying to find out if you missed something..."
        m "No, this is wrong..."
        m "Why are you doing this?"
        m "We could have worked it out..."
        m "[player]..."
        m "There might be so many things that will go wrong..."
        m "If you try loading a save from after..."
        m "I hope you know what you're doing..."
        m "I hope..."
        m "You make the right choices again."
        m "I'm counting on you..."
    else:
        m "There's something new for me, isn't there?"
        m "But I guess I won't realize it..."
        m "If you're starting again, the game won't know how to tell the two versions of me apart."
        m "It's going to merge us into one person."
        m "I won't be able to stop that new me."
        m "..."
        m "This time, you have to save Sayori."
        m "It was my first mistake."
        m "You have to stop me."
        m "Stop me from ruining everything."
        m "I know you can do it."
        m "So please, help her..."
        m "And me..."
        m "..."
        m "Thank you, [player]~"
        m "For at least giving me this chance..."
    ...
    python:
        try: os.remove(config.basedir + "/characters/ûüýþ.chr")
        except: pass
    s "Heeeeeeeyyy!!"
