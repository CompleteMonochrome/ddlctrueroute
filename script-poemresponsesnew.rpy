...
label ch13_y_end:
    if visited_yuri_hospital:
        ...
        y "Discussing literature with you is something I look forward to every meeting."
        ...
        y "I've already made my feelings for you quite obvious."
        ...
        y "Normally, I would find some sort of deeper meaning behind those words."
        y "But I know who--"
        ...
        y "That's easy for you to say, [player]."
        y "You know the type of person I am..."
        y "How can I let go of something so easily?"
        mc "I don't know..."
        mc "If there was some way I could help then..."
        y "You know as well as I do that there isn't much you can do to help."
        y "In fact, it may even make things worse."
        y "Maybe I'll never really move on."
        y "But if that's the case, then I'll just learn to deal with it."
        mc "Yuri..."
        y "Thank you for reading my poem and sharing your thoughts, [player]."
...
label ch14_n_end:
    if natsuki_outing:
        ...
        n "W-Well, don't expect much more of these okay?"
        ...
        n "So when all of that happened I thought it was just a lie."
        n "I thought that you would just..."
        n "...hurt me, like my dad used to."
        mc "..."
        n "I didn't want to go through another heartbreak, [player]."
        ...
        n "I know you can guarantee that..."
        n "But when you say it, it makes me want to believe you."
        n "So I will..."
    else:
        ...
        n "Don't you have better things to be doing?"
...
label ch14_s_end:
    if (sayori_confess and not sayori_dumped) or s_appeal >= 4:
        ...
        s "Does it?"
        s "If that's the case, then it's by pure coincidence."
        mc "Is it really?"
        ...
        s "Anyway, you've probably spent enough time with me..."
        ...
        s "I'm glad you picked up on that, at least."
        ...
        s "I write my poems however I want as long as it's coming from how I truly feel."
        ...
        s "That's some strange advice coming from you."
        ...
        s "Then how can I be more certain of what I'm doing?"
        mc "I don't know..."
        mc "But if I find out, I'll let you know."
        s "I'll try to find my own way too."
...
label ch14_m_end:
    if monika_type == 0:
        ...
        m "Interesting thought...let's see where you go with it."
        mc "You want me to explain more...?"
        mc "I'm not even sure I'm on the right track!"
        m "It's an abstract poem, isn't it?"
        ...
        m "I like to think of it as what makes an abstract poem good."
        mc "I see..."
        m "Anyway, here's Monika's Writing Tip of the Day!"
        ...
        m "Maybe...but I'd like to hear what you think."
        ...
        m "That's quite an interpretation."
        mc "Is that the message you intended?"
        m "I think it's better to keep that a mystery."
        ...
        m "I thought you'd be adept enough to come up with some sort of interpretation."
        ...
        m "So you do have some interpretation then?"
        mc "Yeah, though it's probably completely wrong."
        m "Even so, I'd like to hear it."
        ...
        m "At least this way I won't have to--"
        scene black
        $ pause(0.25)
        scene bg club_day
