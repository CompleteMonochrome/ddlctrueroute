...
label ch13_y_end:
    if visited_yuri_hospital:
        ...
        y "You've brought a light into my world I never would have seen without you."
        ...
        y "T-Thank you..."
        y "I know it's selfish to say but I'm glad you chose me instead of anyone else..."
        y "Natsuki is dealing with a hard time right now and I don't know what to do..."
        y "I would feel like a terrible person...if it wasn't for you."
        y "You just make it seem like all my troubles just aren't there."
        mc "What happened to Natsuki wasn't your fault or mine."
        y "I know...I just feel bad that I care more about you than her."
        mc "Ah..."
        ...
        mc "So I both of us and the rest of the club can do that, together."
        y "Y-Yeah..."
        y "Thank you for sharing your poem and talking to me."
    else:
        call showpoem (poem_y6, img="yuri 3po")
        mc "I don't know what you mean."
        y "W-What?"
        mc "This poem is just as good as any of your other poems."
        mc "If not, better."
        y "Ah...that's kind of you to say."
        y "I'd have to disagree on that."
        mc "How come?"
        y "I already said I couldn't put all the feelings I wanted to in it."
...
label ch13_s_end:
    ...
    mc "I don't know..."
    mc "It feels like the poem is talking about putting a fake personality."
    mc "Then putting up with it just because."
    s "I guess you could look at it that way."
    s "It was just what was on my mind so you shouldn't take it so seriously."
    ...
    s "[player], I didn't have to write about this topic."
    s "I didn't know it would make you feel so uncomfortable..."
    s "Or maybe you just hate my poem."
    ...
    s "It is nice you're worried about me though."
    ...
    s "Yeah..."
    s "Yuri with her...personality was the first thing wasn't it?"
    mc "First thing for what?"
    s "That made you realize this club isn't all just about Literature."
    mc "I didn't join the club just for Literature, Sayori."
    mc "You should know that."
    s "Ehehe, I did know that..."
...
label ch13_m_end:
    if monika_type == 0:
        ...
        m "Yeah, you saw that pretty quickly..."
        ...
        m "But right now isn't really the time or place, okay?."
        mc "Alright..."
        m "Did you at least like the poem?"
        ...
        m "I don't know."
        if y_readpoem:
            m "You've read Yuri's poem, right?"
            m "Maybe you would have felt the same as her."
        m "Anyway, I'm glad you can see the message in the poem."
        ...
        m "What'd you think?"
        m "I tried to make it something you'd see normally."
        m "It was a little difficult last night though."
        mc "Difficult in what way?"
        m "I don't know."
        m "Everything just seemed harder to put into words, I guess."
        m "But I know it's still something I'd be happy to show you."
        mc "Yeah, I could tell there was some stuff you were trying to tell me."
        mc "It's about waiting, isn't it?"
        mc "For the right time?"
        m "I guess you could say that."
        mc "What about...?"
        m "Ahaha, you should know."
        m "If you don't already know what it is, then you'll have to figure it out."
        mc "I guess I do."
        m "Not that I don't want to tell you."
        m "Right now just isn't the time."
        m "Maybe later, [player]."
        mc "I'll think about it."
        m "Ahaha, alright then."
        m 1ha "Anyway..."
        m "I have a writing tip for you, if you want to hear it."
        mc "Yeah, I would."
        mc "It's been a while since I've heard one."
        ...
        m "You don't have to like my poem, [player]."
        ...
        m "It's rather straightforward, isn't it?"
        m "It's about feeling trapped, with nowhere to go."
        m "That is...until it's the right time."
        mc "But when is the right time?"
        m "Who knows?"
        m "Maybe you'll find that out and tell me."
        mc "So this poem isn't about you?"
        m "That's up to your interpretation, [player]."
        m "I have some advice, if you want to hear it."
        mc "Sure, what is it?"
...
label ch13_y_med:
    ...
    y "I don't think it's your fault."
    "Yuri ponders for a moment."
    y "Are you feeling the same as me?"
    mc "I don't know what you mean."
    y "You didn't feel it last night, did you?"
    y "I suppose it could just be me."
    mc "Yuri, I have no idea what you're talking about."
    y "It's a little difficult to explain."
    ...
    y "When I wrote my one last night..."
    y "I just didn't feel anything."
    y "I couldn't invoke the metaphors and emotions that I wanted to."
    mc "That's weird."
...
label ch13_y_good:
    ...
    mc "Confirms what?"
    y "That it's not pointless to go on."
    mc "I'm not sure I understand, Yuri."
    y "It's hard to describe, [player]."
    mc "Try your best."
    y "A-Alright..."
    y "When I was writing my poem last night, I felt...empty."
    y "Usually when I write my poems, I have to concentrate to make it how I want."
    y "The messages and metaphors behind the poem is just how I write."
    y "But you know that already."
    mc "Yeah..."
    y "But last night, when I was concentrating..."
    y "It's like my poem wouldn't have any meaning."
    y "Like I was just writing down empty words on paper."
    y "But then..."
    y "I..."
    "Yuri hesitates."
    ...
    y "It was like the thought of you brought back meaning into my poem."
...
label ch13_s_med:
    ...
    s "Ehehe, I never said that~"
    mc "I can already tell by the tone of your voice you didn't like it."
    s "What?"
    s "I did like it!"
    s "There I said it, are you happy now you big meanie?"
    mc "Whatever you say..."
    s "I can't win with you, can I?"
    ...
    mc "What do you mean?"
    s "You don't...um..."
    s "...{i}feel{/i} any different do you?"
    ...
    s "But I'm just curious what you're feeling."
...
label ch13_s_good:
    ...
    mc "Thanks, Sayori."
    s "It really makes me feel..."
    s "Well...a whole range of stuff, really."
    mc "That's sort of what I was going for."
    mc "I'm just glad you liked it."
    s "Of course I did, it's really good!"
    if y_readpoem:
        "I guess it's good she isn't feeling the same as Yuri was."
    s "[player], I just wanna say."
    s "Hope you're having an awesome day!"
    mc "Eh...?"
    mc "Where did {i}that{/i} come from?"
    s "Is there something wrong with wishing you an awesome day?"
    mc "No..."
    mc "It just seems kinda random."
    s "Well, maybe I just want to thank you for this poem."
    mc "If you say so..."
    s "And besides, I know how you felt about yesterday."
    s "It was a weird day, wasn't it?"
    s "I'm sure everyone is thinking about it."
    mc "Yeah..."
    s "So I'm hoping you don't feel that way again."
    s "That's why I'm wishing you an awesome day!"
    "Sayori beams."
    mc "Thanks..."
    ...
    s "Anyway, you can read what I wrote now."
...
label ch13_m_start:
    if monika_type == 0:
        ...
        m "Yesterday sure was strange, wasn't it?"
        ...
        m "Ahaha, I don't think something like that will happen again."
        ...
        m "Well...the sight of your--"
        mc "Who are you talking to?"
        m "Ah..."
        m "Sorry, I was just speaking to myself."
        ...
        m "Anyway...how do you feel about what happened yesterday?"
        ...
        m "Ahaha, it is quite a lot of excitement coming from a club like this."
        mc "Yeah, not something I'd like to do again anytime soon."
        m "Well...that might not be an option."
        mc "What?"
        m "Nothing~"
        mc "So I was wondering why you have your hair like that."
        m "I just thought I'd change up my look a little."
        m "It helps distinguish me from the others."
        mc "What do you mean by that?"
        mc "Yuri already has her hair down--"
        m "Are you saying you don't like it?"
        m "I can change it back...if you want."
        mc "N-No...I like it."
        mc "Just forget I said anything."
        m "Ahaha, okay~"
        m "I'll take a look at your poem now."
    else:
        m "[player]."
        mc "Monika."
        m "Come to share your poem with me?"
        mc "I suppose I have."
    ...
    if monika_type == 0:
        m "It hasn't affected you, I think."
        ...
        m "The way you wrote your poem still feels the same."
        m "At least to me."
        mc "Is that a good thing?"
        m "I'm not sure..."
        m "But anyway, you haven't read my poem."
        m "Here, tell me what you think."
    elif monika_type == 1 and ch12_markov_agree:
        m "Hmm...I {i}feel{/i} like your poem should be different."
        m "Like there should be something missing..."
        m "But there isn't."
        mc "What do you mean?"
        m "Your poems are still written in the same way."
        ...
        m "Speaking of which, you haven't observed my poem yet."
        "Monika hands me her poem."
    else:
        m "I hope you'll forgive me if I seem a little out of it today."
        m "I'm just in a rush for the meeting to be over, that's all."
        mc "Ah...I see."
        mc "I thought you just didn't like my poem or something."
        m "You aren't the reason I'm acting like this."
...
label msay_universal_1:
    if monika_type == 0:
        m "Ah, you wrote this in the style of [ch13poemwinner]'s poems."
        mc "I did."
        m "Does that mean..."
        ...
        m "After all, all your poems until now have been like mine."
        m "I just thought that..."
        m "...you'd continue in that way."
        ...
        m "Not that I didn't like the poem."
        m "I don't really have an opinion on it one way or another."
        m "Sorry if that isn't what you expected."
        mc "Ah, it's okay."
...
label msay_monika_1:
    if monika_type == 0:
        m "You wrote this poem for me, didn't you?"
        ...
        m "I know I said before that you should look at different styles..."
        ...
        m "Ahaha, thank you again [player]."
        ...
        m "It's like..."
        m "Hmm..."
        m "Well, it makes me feel grateful."
        m "So thank you."
        ...
        m "Is there even a point to your poem?"
        mc "W-What do you mean?"
        m "You're writing this for me, clearly."
        ...
        m "Anyway, there's no point talking about it any futher."
