...
label ch14_m_end:
    if monika_type == 0:
        ...
        m 1hl "It sounds like something out of a movie, right?"
        ...
        m 2hb "Maybe...but I'd like to hear what you think."
        ...
        m 1hl "That's...quite an interpretation."
        mc "Is that the message you intended?"
        m 1ha "I think it's better to keep that a mystery."
        m "After all, having many interpretations is what makes an abstract poem good."
        mc "I see..."
        m 3hb "Anyway, here's Monika's Writing Tip of the Day!"
        m "Sometimes when you're writing, you may want to point out the obvious to give a sense of setting."
        m "You could say that the sky is dark indicating it's night time, but you could instead describe the setting..."
        m "While at the same time still describing the sky is dark."
        m "Describe your surroundings, maybe show the faint light through the window."
...
label ch14_m_start:
    if monika_type == 0:
        ...
        mc "You think so?"
        m 2hb "Ahaha, do you think I'd lie to you?"
        mc "Well...I guess not."
        m 5ha "You're really quite talented, [player]."
        ...
        m 3hb "You should probably give yourself more credit!"
        "Monika smiles meaningfully."
        if ch13_name == "Monika":
            m 1he "Anyway, I'd like to apologize for yesterday."
            ...
            m 1hd "At this point in time, I don't even know if it's possible."
            mc "You can always try, can't you?"
            m "I suppose..."
            m 1he "Though sometimes I don't know if I should really resist it."
            ...
            m 2hb "You'll have it done before Friday, right?"
            ...
            m 2hc "So you think you made the right decision then?"
            m "About choosing who to help."
            mc "I think so..."
            mc "It's not like I can change that decision now, can I?"
            m 2ha "Ahaha, I suppose not."
            mc "What about you?"
            mc "Are your preparations doing okay?"
            m 4hb "They're going fine."
            m 4hn "I guess they could be doing a little better if I had some help..."
            mc "Sorry about that, Monika..."
            m 1ha "I'm only kidding! My preparations are more suited towards one person anyway."
            m "I'm sure [ch13_name] definitely needs your help more than me."
            mc "Yeah..."
            mc "Have you already got a song in mind?"
            m 2hb "Actually, I've got several songs in mind."
            ...
            m 2ha "Though I do hope you'll like it when I do play it."
            mc "I'm sure anything by you is going to sound great."
            mc "I have no doubt about that."
            m 1he "That's kind of you to say."
    ...
    if monika_type == 0:
        ...
        m 1he "The day is going just like that, isn't it?"
        ...
        m 2he "So we can all continue our preparations after the meeting."
        mc "Maybe...though it could mean we should slow down."
        mc "There's more than one way to look at it."
        m 2ha "You're right!"
        m "It's just a matter of perspective, isn't it?"
        m 1ha "In any case, we're here to share poems."
...
label msay_universal_2:
    if monika_type == 0:
        ...
        m 1hc "It's a poem in the style of [ch14poemwinner]."
        m "Quite interesting..."
        mc "Really?"
        m 1he "Well, as interesting as it can get lately."
        m "Keep up the good work, [player]."
        m "And always remember, write from your heart."
        mc "From my heart?"
        "Am I not already doing that...?"
        m 2ha "You may not really care about poems now but you should still put effort into your poems."
        m "Writing from the heart is a good indication that you're putting effort into it."
        mc "I see..."
        m 3hl "You don't have to follow my advice, of course!"
...
label msay_monika_2:
    if monika_type == 0:
        ...
        m 2ha "You wrote this poem thinking of me, right?"
        mc "You got me."
        m "That's so nice of you, [player]."
        m 1hn "I know it's kinda selfish of me to say..."
        ...
        m 1he "I think I understand, [player]."
