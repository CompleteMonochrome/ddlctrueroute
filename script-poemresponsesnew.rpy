...
label ch15_y_end:
    if visited_yuri_hospital:
        call showpoem (poem_y8b, img="yuri 3pa")
        mc "Yuri, this poem..."
        y "It's too much, isn't it?"
        y "I thought it would be."
        y "I wanted to tone it down a little bit but..."
        y "Ah..."
        y "I'm sorry."
        mc "What? No."
        ...
        y "Thank you for that, [player]."
        mc "Not a problem, Yuri."
    else:
        call showpoem (poem_y8, img="yuri 3pa")
        "What's up with this poem...?"
        mc "Hey, Yuri..."
        y "It's terrible, I know."
...
label ch15_n_end:
    if natsuki_date:
        ...
        n "I-I didn't make this just for you!"
        ...
        n "I'll be fine."
        mc "Are you sure?"
        n "I'll get over it soon."
        n "What I'm bitter about isn't it my control anyway."
        n "So I shouldn't be so upset about it."
        n "But I am so..."
...
label ch15_m_start:
    if monika_type == 0:
        ...
        m "Right."
        m "The activity that started a long time ago."
        ...
        menu:
            ...
            "No." if not persistent.markov_agreed:
                ...
                m "And you really believe that?"
                mc "Yeah..."
                m "I suppose we all have our own opinions about things."
        m "Anyway, you came here to show me your poem."
        m "Well, since you wrote it, it has to be good."
    ...
    if monika_type == 0 or (monika_type == 1 and ch12_markov_agree):
        m "Anyway, let's hurry this up."
        m "Like Sayori said, there's a lot to do tonight."
        m "In fact, I think I know what's going to be happening."
        mc "You do? What is it?"
        m "I think that's best life as a surprise."
        m "You'll see."
        m "It would be pretty beneficial to all of us if we finish up quickly though."
        m "But before that, there's something I have to tell you."
        ...
        m "I'm glad you like them, [player]."
        m "I do want everyone to improve their writing."
        m "By improving your writing, you're also improving yourself in a way."
        ...
        m "[player], you want some advice?"
        mc "Advice? As in a writing tip?"
        m "Sure, why not."
        m "Here's Monika's Advice of the Day!"
...
label msay_universal_3:
    if monika_type == 0:
        m "Another one in the style of [ch15poemwinner]?"
        m "You've really dedicated yourself to writing in her style, haven't you?"
        mc "I guess I have."
        m "I wonder what caused this change."
        m "Could it be you have feelings for her?"
        mc "W-What?"
        m "Ahaha, kidding~"
        m "I remember when you used to write in my style, you know."
        mc "Oh..."
        m "It's not a bad thing you've changed."
        m "It's probably a good thing."
        m "It's not like it matters at this point anyway."
        mc "Monika, I'm--"
        m "I'm not upset or anything!"
        m "So don't take it the wrong way."
        m "I'm just making an observation."
        mc "If you say so."
        mc "I just want to say sorry for doing this to you."
        m "There's no need, really."
        ...
        m "I'm not upset. Perhaps I'm disappointed."
        m "But it's nothing I won't get over."
        mc "I'm sorry."
        m "Don't apologize for this."
        m "It's a small issue, and the more we talk about it the bigger it escalates."
        m "Let's just leave it here, while it's not important."
        mc "If you say so."
    else:
        m "I see."
        mc "You see?"
        ...
        m "Your poem style."
        m "It's clearly not meant for me."
        m "At least, not anymore."
        mc "Is it that obvious?"
        m "It is..."
        mc "Monika, I--"
        m "There's no need to explain yourself."
        m "Whether you write your poems in the style of mine or [ch15poemwinner]'s is of no concern to me."
        m "You control what happens after all."
        mc "I control what happens?"
        "What an odd thing to say."
        mc "It's just...you look upset."
        m "Trust me, I'm hardly upset over this."
        m "So let's just move on, okay?"
        m "No sense making a big deal out of a small issue like this."
        mc "Yeah...okay."
    return

label msay_monika_3:
    if monika_type == 0:
        m "You're just continuing to write in my style, aren't you?"
        ...
        m "Do you think that's a bad thing?"
        m "My influence..."
        mc "N-No! No way."
        ...
        m "I'm glad to have known you."
        m "To be part of the same club as you."
        m "Ahaha, to think this conversation was only possible because of your poems."
        m "Who knew it would have had such an effect, right?"
        mc "Yeah, it's strange how things just work out."
        m "You have no idea..."
        if persistent.markov_agreed:
            m "It's a shame you made the wrong choice before."
            m "Everything you've done will come back to haunt you."
            mc "What?"
            m "Oh, I was just talking to myself."
        m "But thanks for sharing your poem."
        m "It's always a pleasure."
    elif monika_type == 1 and ch12_markov_agree:
        m "This..."
        mc "Is something wrong?"
        m "Not at all."
        m "In fact, things are as they should be."
        m "This poem is proof of that."
        mc "It is?"
        mc "I'm sorry, Monika but I don't really understand."
        m "You've written almost every poem for me, right?"
        mc "Yeah...?"
        m "In fact, I think it's been every single one."
        ...
        m "Are you trying to get a reaction from me?"
        ...
        if monika_type == 1:
            m "There might have been if..."
            m "No, I can't think about that."
            m "It just gives me a huge feeling of regret."
        elif ch12_markov_agree:
            m "All we are is partners."
            m "Nothing more."
        ...
        mc "I-If you say so..."
        m "There's just one thing."
        m "If I don't care about you..."
        m "Why does seeing these poems have this effect on me?"
        m "I can't describe it."
        m "It's like I'm being forced to enjoy it and..."
        m "It's disgusting."
        mc "Right..."
        ...
        m "I don't know what I was expecting."
        m "But it's done."
        m "Whatever delusions you have will never come to fruition."
