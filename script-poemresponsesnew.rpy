...
label ch7_m_end:
    if m_appeal == 2 and did_all_tasks:
        ...
        m "Try and find another person to have a look at it to ensure you didn't miss anything."
...
label ch6_n_good:
    ...
    mc "If you really think it's that good, I might try and study it a bit."
...
label ch7_n_med:
    ...
    mc "Thanks, I did try and put more thought into this one."
...
label ch7_s_med:
    ...
    mc "Thanks..."
    mc "I did try and make this one better than my last."
...
label ch7_s_good:
    ...
    mc "But I did try and make this my best one."
...
label ch12_m_start:
    ...
    if monika_type == 0:
        ...
        mc "I'll try and answer to the best of my ability."
...
label mnew_monika_4:
    if monika_type == 0:
        ...
        m 3j "Or is this still a desperate attempt to try and get her back?"
        mc "Monika, what are you talking about?"
        m 1h "Hmm..."
