...
label ch15_y_end:
    if visited_yuri_hospital:
        call showpoem (poem_y8b, img="yuri 3pq")
        mc "Yuri, this poem..."
        y "It's too much, isn't it?"
        y "I thought it would be."
        y 3po "I wanted to tone it down a little bit but..."
        y "Ah..."
        y "I'm sorry."
        mc "What? No."
        mc "This poem is incredible."
        mc "The message behind it..."
        mc "It's like you're finding yourself."
        y 2pe "Finding myself...?"
        mc "That's the message I'm getting."
        mc "Since the poem is about being lost and hopeless, right?"
        y 2pf "It's about a guiding light."
        y "Getting me through the worst of it."
        y "But that in itself is a metaphor of something else."
        y 4pb "I'm sure you can probably guess it..."
        mc "The light is..."
        mc "...me, right?"
        y 4pc "That's right."
        y "You've been the guiding light, [player]."
        y 4pa "Who I am today is because of you."
        mc "I don't think that's true, Yuri."
        mc "We've only known each other for a couple of weeks."
        mc "You're your own person."
        y 3pt "But where would I be right now if I didn't meet you?"
        y "What kind of person would I have become...?"
        mc "I don't know."
        mc "But if you need me to be your guiding light."
        "I take Yuri's hands."
        mc "Then I'll be right here beside you."
        show yuri 4pe
        "Yuri's face turns a bright red."
        y "B-But..."
        mc "Something wrong?"
        y "..."
        y "You can't be a guiding light if you're next to me..."
        y "You have to be leading the way..."
        mc "Hah, I suppose that's true!"
        "Yuri and I both laugh."
        y 3pu "Thank you for that, [player]."
        mc "Not a problem, Yuri."
    else:
        call showpoem (poem_y8, img="yuri 3pg")
        "What's up with this poem...?"
        mc "Hey, Yuri..."
        y 3pt "It's terrible, I know."
        y "I'm sorry for sharing this with you."
        y "I've been really dropping my standards lately..."
        mc "No way, it's a great poem."
        mc "I'm just a bit confused by the messages in it."
        mc "It sounds...kinda grim?"
        mc "Does this poem have anything to do with you?"
        y 3pv "Of course it does..."
        y "All of my poems mean something to me."
        y "I take a part of my life and try to express it through metaphors."
        mc "That's all it is?"
        mc "Metaphors?"
        y 3pw "..."
        y "Why do you ask?"
        mc "I don't know."
        mc "I guess I'm worrying too much."
        mc "I can't help it though."
        y 2pf "What do you mean?"
        mc "Well, it kinda feels like you're not really in control."
        mc "At least, according to the poem."
        y 2pa "It's...nothing."
        y "I think you're overthinking it, [player]."
        mc "That's what I'm supposed to say about you."
        mc "But if you're sure it's nothing then..."
        y 2pb "I'm sure."
        y "Thank you for sharing poems with me, [player]."
        mc "Anytime."
    return
...
label ch6_n_end:
    ...
    n 5e "And it's easier to write about the sad things than it is about the happy things."
...
label ch9_n_end:
    ...
    if n_appeal >= 3:
        ...
        n "I don't really know why I'm telling you this."
...
label ch14_n_end:
    if natsuki_date:
        ...
        n "Every time I say it, it becomes easier to admit."
...
label ch15_n_end:
    if natsuki_date:
        call showpoem (poem_n10b)
        mc "Reading a poem by you always brightens my day, Natsuki."
        mc "Thank you for sharing this with me."
        n 2e "I-I didn't make this just for you!"
        n "It's for everyone to read!"
        mc "I never said it was just for me."
        mc "I just said that I'm happy to read a poem by you."
        mc "Because they're always really good, you know that right?"
        n 2q "Y-You're just saying that."
        n "My poems are nothing compared to Sayori's or Monika's."
        mc "That's definitely not true."
        mc "I enjoy your poems a lot more than everyone else's."
        mc "You should know that by now."
        mc "After all..."
        mc "You're the one who got me to start writing in a..."
        mc "Simple yet unique way?"
        n 2o "Ugh..."
        n 2p "You're so...!"
        "Natsuki tries to hide a smile."
        n 1t "You can probably tell already."
        n "But you're the one reaching out."
        n "The hand that helped me get through what happened."
        n 1j "The hand that's still helping me..."
        mc "And I'll continue to reach out."
        mc "As long as you need me."
        mc "After all, we're together now."
        n 1c "Yeah..."
        "Natsuki leans closer to me."
        n "I just want to make it through this, [player]."
        n "And with you, I know I can."
        mc "I feel the same."
        show natsuki at h11
        "Natsuki quickly steps back."
        n 1q "Anyway!"
        if poemsread < 4:
            n "You should go read everyone else's poem."
        else:
            n "We should get back before Sayori gets mad at us."
    else:
        call showpoem (poem_n10)
        mc "This poem seems..."
        mc "I don't know, not really something you'd write."
        n 1k "Actually, you're right."
        n "It's something more desperate."
        n 1c "More emotional but still trying to stick to my own style."
        n 2q "I guess it didn't really work, huh?"
        mc "It does."
        mc "I think it's a great poem, Natsuki."
        mc "You don't have to listen to me but I think you should stick to your own style."
        mc "I like your poems because they're different to everyone else's."
        mc "It just seems so unlike you."
        n 2s "Unlike me? Because it's not cute?"
        mc "Well..."
        n 2h "It doesn't matter anyway."
        n "It's mostly me just running out of ideas."
        n 2r "And being bitter of a lot of things."
        mc "What's there to be bitter about?"
        mc "Is it something at home?"
        show natsuki 2i
        if ch13_name == "Natsuki":
            n "You've been to my home."
            n "What do you think it is?"
            n "It's nothing to do with my home, [player]."
        elif ch12_outcome == 3:
            n "Why would it be something at home?"
            n "My parents are together..."
            n "I'm just adapting, that's all."
        elif ch12_outcome == 2:
            n "Why would it be?"
            n "I have my mom back and..."
            n "Yasuhiro is gone."
        elif ch12_outcome == 1:
            n "What makes you think that?"
            n "My dad is back to himself...mostly."
            n "And we're trying to get along as best we can."
        else:
            n "I'm alone at home, [player]."
            n "There's nothing there."
            n "Which means there's nothing to get bitter about."
        mc "I was just asking."
        mc "I'm worried about you, that's all."
        n 1g "I'll be fine."
        mc "Are you sure?"
        n 1q "I'll get over it soon."
        n "What I'm bitter about isn't in my control anyway."
        n 1s "So I shouldn't be so upset about it."
        n "But I am so..."
        mc "I'm here if you want to talk."
        n 1i "Thanks, but..."
        n "There's no time for that, [player]."
...
label ch14_s_end:
    if (sayori_confess and not sayori_dumped) or s_appeal >= 4:
        ...
        mc "Whatever it is you're talking about in your poem..."
...
label ch15_s_end:
    if ch14_sayori_date_choice and sayori_personality <= 0:
        ...
        s 1d "Monika didn't have anything to do with this, [player]."
        ...
        s 1q "It just might be~"
        mc "Eh?"
        s 2r "Nothing!"
        s 2a "Remember you still owe me that date."
        s "You did lose yesterday, remember?"
        s 2k "{i}(If this is what I really want...){/i}"
        mc "I didn't forget."
        ...
        s 1l "[player], what you said just made no sense."
        s "Did you get enough sleep?"
        mc "I got plenty of sleep."
        s 2d "And anyway, my poem has nothing to do with what's going on."
        s "It's just telling a story."
        mc "A story of what exactly?"
        s 2c "Of someone in conflict."
        ...
        s 1d "Thanks for sharing, [player]."
    else:
        call showpoem (poem_s10)
        mc "Hmm..."
        mc "Is it just me or--"
        s 1f "It seems like an ending poem, right?"
...
label ch9_m_end:
    if m_appeal == 3 and did_all_tasks:
        ...
        mc "It seems like you're writing it from a certain perspective."
...
label ch12_m_end:
    if monika_type == 0:
        ...
        m 1l "That's okay, I don't take any offense to that."
...
label ch14_m_end:
    if monika_type == 0:
        ...
        m "There can be many interpretations of what anything is."
        mc "I guess but..."
...
label ch15_m_end:
    if monika_type == 0:
        call showpoem (poem_m12c)
        mc "Correct me if I'm wrong but..."
        mc "It sounds like a story of corruption, or maybe change?"
        mc "I know it's abstract but I can't help but feel there's a direct message in it."
        m 1c "You caught on rather quickly."
        mc "Do you have a reason for writing it?"
        mc "It just seems...strange."
        m 1e "There's a number of things."
        mc "It wouldn't have anything to do with the danger?"
        m 1m "Well...it's hard to say."
        m "I'm not entirely sure if I wrote it because of that."
        m 1n "I don't think it was."
        mc "I see."
        m "You know, it's hard for people to realize they've completely changed who they are."
        m 2o "A once kind and gentle person could, over time, transfer into an evil-hearted savage."
        m "All it would take is something or many things in their life to transform them."
        m "Maybe someone close to them died or they were really hurt emotionally."
        m 2p "Those types of things completely rewrite their personality."
        mc "That's kinda scary to think about."
        m 1f "It is."
        m "Do you ever look back at people you used to know years back and see them now?"
        m "They're hardly ever the same."
        m 1m "Sure, there are similarities."
        m "You don't lose all of yourself over a couple of years."
        m "But they're different."
        m "And you know it."
        m 1l "Of course, that's not all the time!"
        mc "Well..."
        mc "I wouldn't say it's been years but someone I know has changed a lot."
        mc "Over a really short period of time, actually."
        mc "I don't know if I should be worried."
        m 1d "Oh?"
        m "You're not talking about..."
        m 1e "...Me, are you?"
        mc "What? No."
        mc "You're still just Monika."
        mc "I don't think you've changed."
        mc "At least, I hope you haven't."
        mc "You're perfect just the way you are."
        m 2l "Ah...I'm flattered."
        m 2d "But if you weren't talking about me then...?"
        mc "I'm talking about Sayori."
        m 2e "I...see."
        m "Well, you've known her a lot longer than the rest of us."
        m "She's probably changed a lot from her childhood self."
        m "To us, she's always been like this."
        mc "I guess it's a matter of perspective."
    elif monika_type == 1 and ch12_markov_agree:
        call showpoem (poem_m12b)
        mc "This poem really made me think about what really goes on in people's heads."
        m 1c "What do you mean by that?"
        mc "Well, some people who are evil think they're doing the right thing."
        mc "They think that they're helping the world by doing whatever evil scheme they have."
        mc "Because in their head, they're the good guy."
        m 1l "You sure you haven't been watching too much anime, [player]?"
        mc "Honestly, I might have."
        mc "But it's an interesting thing, isn't it?"
        mc "Seeing as you wrote about it, after all."
        m 2a "Hmmm..."
        m "I wrote it because I think some people are misled on their beliefs."
        m "I'll try to make it something you can understand."
        m 4b "Perspective is important because it allows people to perceive who the good and bad guys are."
        m "To the masses, the bad guy is the one destroying the planet."
        m 4c "The good guys are the ones stopping him."
        m "In reality, the bad guy is simply doing his best to protect the planet."
        m 3d "Even if it means making sacrifices."
        m "The good guys are doing the same too but in a completely different way."
        m "Some would see the bad guy as a hero of some sort, while most would be afraid of him."
        m 3b "What do you think, [player]?"
        m "Is he a bad guy?"
        mc "It depends..."
        mc "If his methods were extreme then maybe he would be a bad guy."
        m 1e "But if it all leads to the same thing, then what?"
        mc "I think having just means to reach the end is important."
        mc "Otherwise, there would be anarchy."
        m 1a "Surprising answer coming from you."
        m "{i}(But I'll do whatever it takes to get my end...){/i}"
        mc "What was that?"
        ...
        mc "Seeing as you wrote it."
        m 1c "Interpret it however you like, [player]."
        m "It doesn't matter."
        m "Abstract or not, it's still got its own meaning to me."
        m 2h "And I'm not going to divulge anything."
        mc "Okay...?"
        "Seriously, what's up with her?"
        mc "I thought you would want to talk about what you wrote."

    if monika_type == 0 or (monika_type ==1 and ch12_markov_agree):
        m 2a "That was a good talk, [player]."
        m "There's just one more thing we have to talk about."
        mc "Your writing tip of the day?"
        m 1b "You know me too well!"
        mc "I'm always happy to get one from you."
        mc "They're helpful and a lot of the time I can actually use them."
        mc "I just want to say thanks for all the tips over the time I've been here."
        m 1e "I'm glad you like them, [player]."
        m "I do want everyone to improve their writing."
        m 3j "By improving your writing, you're also improving yourself in a way."
        mc "I suppose that's true."
        m "Ehm."
        "Monika clears her throat."
        m 3b "Here's Monika's Writing Tip of the Day!"
        m "Sometimes when you're writing something you may get burnt out."
        m "You'll start to lose motivation and eventually stop working on a project altogether."
        m "One way that I use to solve this is to give yourself goals."
        m "By giving yourself goals on a project, you'll be more committed to working on it."
        m "You'll have a higher sense of accomplishment once you get it done too."
        m "For example, you could start off small."
        m "It could be as simple as \"finish three hundred words\". As long as you get something done, that's the important bit."
        m "Eventually, you'll actually start getting a lot more done and you'll be happy you didn't drop the project."
        m "This doesn't just apply to writing but anything you're spending a lot of time on too."
        m "As long as you're doing something related to it, you'll keep an interest and eventually get it done."
        m 3k "That's my advice for today."
        m "Thanks for listening~"
        mc "There's one thing I'm wondering."
        "Monika looks visibly surprised."
        m 3d "Huh?"
        m 1n "Um...okay. What is it?"
        mc "Since Sayori is the president, why isn't she the one that gives out writing tips?"
        mc "I would have thought she'd be better at it, since she started the club and all."
        m 1c "Well...just because she's the president doesn't mean she's the best qualified for giving out tips."
        m 1e "Besides, it's not like you've ever asked her for writing tips."
        mc "I guess that's true."
        mc "I prefer hearing them from you, anyway."
        mc "Hearing them from anyone else at this point would be weird."
        m 1l "I'm sure that was probably a compliment."
        mc "It definitely was."
        m 1j "Ahaha, okay."
        m 1e "If that's all, then let's move on."
        m "I've already taken up far too much of your time."
    else:
        m 2b "[player], you want some advice?"
        mc "Advice? As in a writing tip?"
        mc "Sure, why not."
        m 1c "Then listen carefully."
        m 3h "Here's Monika's Advice of the Day!"
        if ch13_name == "Monika" or ch12_markov_agree:
            m "Don't get ahead of yourself."
            if ch12_markov_agree:
                m "We're only partners in this."
                m "Nothing more."
            else:
            ...
            "..."
            m 3l "Well, that's close enough."
            m 1h "And I suppose you can't really control if you speak to me."
            m "It's all predestined, isn't it?"
            m "All of this."
            m 1i "No response..."
            m "I'm bored speaking to you."
            m 1c "Why don't you just go now?"
            m "There's still so much to figure out tonight."
            m 1d "So much to plan to make all of this work."
            m "And even then, it's a chance."
            m "I hope you're ready."
        else:
            m "Mind your own business."
            m "You should learn to understand signs."
            m "Like the ones I've been giving."
            m "If someone clearly doesn't want to talk to you, then stop."
            m "It's only going to annoy whoever you're talking to more."
            m "It'd be best if you just stayed out of a busy person's way."
            m "Let them accomplish whatever they're trying to."
            m 3i "That's my advice for today."
            m "You should take it to heart."
    return
...
label ch14_n_good:
    ...
    n "It's so embarrassing to think about..."
...
label ch15_n_med:
    ...
    n 2c "Where are you getting that idea from?"
...
label ch15_n_good:
    ...
    n 1o "N-No! It's not that."
    n "It's just..."
    n 1q "Well, tomorrow has me thinking."
    ...
    n 2s "Y-You're just saying that."
    mc "Maybe I am."
    mc "There's no way."
    ...
    n 2f "Being a jerk."
    n 1s "Thanks for lowering my confidence."
    mc "That's what I'm here for."
    "Natsuki rolls her eyes."
    n 2c "Whatever, why don't you just take this?"
    n 2e "And wipe that grin off your face!"
    mc "You're cute when you're angry."
    mc "Do you know that?"
    n 1v "Shut up and take it already...!"
    "I take Natsuki's poem."
    return
...
label ch13_y_good:
    ...
    y "S-Sorry, this is really embarrassing to say."
    mc "No, it's fine."
...
label ch14_y_med:
    ...
    if ch13_name == "Yuri":
        ...
        mc "So there should be nothing to worry about."
        y 3pk "Well, that's good..."
...
label ch15_y_med:
    ...
    y 2pa "I was just thinking to myself."
    y "I must have accidentally said something."
    mc "I see..."
    mc "Well, what are you thinking then?"
    y 2pb "Oh, it's written well."
    y "..."
    y 3pq "Sorry, I don't really have much to say."
...
label ch15_y_good:
    ...
    y 3pf "There's nothing wrong with it."
    y "I may be a bit biased but it's hard for me to find faults in your poems lately."
    y 3pi "Your writing has gotten to a level where I'd say it's above the average of people your age."
    y 2pa "Even if the content isn't always what I'd like, it's just hard for me to criticize you."
    mc "I see..."
    "Yuri smiles at me."
    "Seeing her smile always gives me a warm feeling in my heart."
    y 2pb "The day is fast approaching, [player]."
    y "Are you ready for what's coming?"
    mc "Ready for the play?"
    mc "I guess I am."
    y 1e "There's more to the day than just the play."
    y "We're going to be in contact with so many people."
    y 1j "We have to make sure they enjoy themselves."
    mc "Any idea how we're going to do that?"
    y 1s "The decorations are going to help."
    if ch13_name == "Yuri":
...
label ch15_s_med:
    ...
    s 2a "Just keep doing what you're doing."
    s 2d "{i}(While you can...){/i}"
    mc "What did you say?"
    ...
    if ch13_name == "Sayori":
        ...
        s 1d "I want you to know, I'm glad you helped her."
        mc "Who? [ch13_name]?"
        ...
        s 1a "And in any case, I'm sure she enjoys your company."
        s "Just having you around probably brightened up her day."
        mc "Y-Yeah, we'll go with that."
    s 1q "Anyway, let's get on with it."
    s "Lots to do after all, right?"
    mc "Yeah..."
    s "So here, why don't you read my poem?"
    "Sayori offers me her poem and I take it."
    return

label ch15_s_good:
    s "This is a really sweet poem, [player]."
    s 2q "The mix of emotions combined with your writing style is a really cool combination."
    mc "Cool combination, eh?"
    s 2l "W-What? I'm running out of ways to compliment your poems..."
    mc "Well, I'm glad you like it."
    show sayori 4q
    "Sayori beams."
    s 4d "I never really get the chance to say this, [player]."
    mc "Say what?"
    if sayori_confess and not sayori_dumped:
    ...
    s 4r "Well, I just thought I'd say that."
    s "It's going to be one of the last times we share poems after all."
    mc "What?"
    s 2l "Nothing!"
    "Did I hear that correctly?"
    s 1d "I wanted to tell you something else as well."
    if ch13_name == "Sayori":
        s "Thanks for helping me yesterday."
        ...
        mc "You think so?"
        s 1a "I know so."
    s 1d "Anyway, let's get on with it."
    s "We have a long night ahead of us."
    mc "That's right."
    s "I guess I should probably show you my poem now."
...
label ch14_m_start:
    if monika_type == 0:
        ...
        if ch13_name == "Monika":
            ...
            mc "I wouldn't be surprised if there were some other things you had to deal with as well."
...
label ch15_m_start:
    if monika_type == 0:
        ...
        m 2e "It's all coming to an end."
        m "Everything we've worked so hard for."
        mc "You mean the preparations?"
        mc "I suppose it is."
        m 2b "I've been making some of my own preparations too."
        ...
        if ch13_name == "Monika":
            ...
            m 1e "Meaning the part you're going to play."
            "I stare at her blankly."
            m "You have no idea, do you?"
        mc "Uhh..."
        m 2k "Ahaha~"
        m "Don't worry, I'm just messing around."
        m 1a "There's nothing for you to worry about."
        m "I can't say the same about the others though..."
        mc "...Right."
        m 1b "So, let's see what you've written today."
        m "I'm sure it's a masterpiece in its own right."
    else:
        m "The pieces are coming together."
        m 1b "Soon, it will all be over."
        mc "Okay...?"
        m 1e "Oh, [player]!"
        "Monika smiles nervously."
        m "Ahaha, sorry I didn't notice you there."
        m 2a "I was just talking to myself."
        mc "What do you mean by the pieces are coming together?"
        mc "It sounded kinda..."
        mc "I don't know, sinister?"
        m 2n "S-Sinister?"
        m "I-I don't know what you're talking about."
        m "I wasn't even aware you heard me say that."
        mc "I was going to show you my poem."
        mc "And I overheard."
        m 1h "Right."
        m "The poem sharing activity."
        m 1i "The activity that started a long time ago."
        m "The activity that we're still doing after all this time."
        m "Rather pointless, don't you agree?"
        menu:
            mc "..."
            "Yes.":
                mc "Yeah, you're right."
                mc "It is pointless."
                m 1j "I'm glad we're in agreeance."
                m "After all, we're doing this together."
                if not ch12_markov_agree:
                    mc "...What?"
                    m "Nothing~"
            "No." if not persistent.markov_agreed:
                mc "I don't think it's entirely pointless."
                mc "There has to be some reason for it."
                m 1c "And you really believe that?"
                mc "Yeah..."
                m "I suppose we all have our own opinions about things."
        m 1d "Anyway, you came here to show me your poem."
        m 1j "And well, since you wrote it, it has to be good."
    ...
    if monika_type == 0 or (monika_type == 1 and ch12_markov_agree):
        m 2b "[player], let's hurry this up."
        m "Like Sayori said, there's a lot to do tonight."
        m 2a "In fact, I think I know what's going to be happening."
        mc "You do? What is it?"
        m "I think that's best left as a surprise."
        m 2j "You might like it, actually."
        m "You'll see."
        m 2a "It would be pretty beneficial to all of us if we finish up quickly though."
        m "So here, why don't you read my poem now?"
        mc "Sure."
    else:
        m 1h "Let's get this over with."
        m "Before I get sick."
        mc "Sick?"
        mc "Do you have a fever?"
        m 1f "What?"
        m "No, I don't have a fever!"
        mc "Sorry, I'm just concerned."
        m 1i "Well, don't be."
        m "You have no reason to."
        mc "It's just...you've been acting weird."
        mc "And I'm worried about you."
        m 1c "Look, I don't need your sympathy or anything."
        m "I have to show you my poem, so that's what I'm going to do."
    return
...
label msay_universal_3:
    if monika_type == 0:
        m 1m "Another one in the style of [ch15poemwinner]?"
        m 1n "You've really dedicated yourself to writing in her style, haven't you?"
        mc "I guess I have."
        m 2c "I wonder what caused this change."
        m 4a "Could it be you have feelings for her?"
        mc "W-What?"
        m 4j "Ahaha, kidding~"
        m 2a "I remember when you used to write in my style, you know."
        mc "Oh..."
        m 2b "It's not a bad thing you've changed."
        m "It's probably a good thing."
        m 2e "It's not like it matters at this point anyway."
        mc "Monika, I'm--"
        m 2m "I'm not upset or anything!"
        m "So don't take it the wrong way."
        m 2n "I'm just making an observation."
        mc "If you say so."
        mc "I just want to say sorry for doing this to you."
        m 1a "There's no need, really."
        m "It's a small issue."
        m "Talking more about it will only make it a big issue when it doesn't need to be."
        mc "You're probably right."
    elif monika_type == 1 and ch12_markov_agree:
        m 1c "Hmm..."
        m "This is a bit odd, if I might say."
        mc "What is?"
        m 1d "Your last few poems."
        m "They haven't been written in my style."
        mc "Oh...yeah."
        mc "I guess I've just been doing my own thing."
        m 2f "Doing your own thing?"
        m "[player], it isn't very difficult to tell that this is [ch15poemwinner]'s style."
        m "There's no use denying it."
        mc "Ah..."
        mc "Well, you're not wrong."
        m 2m "I hardly am."
        m "Anyway, I'm not going to judge you."
        m 2n "I'm not upset. Perhaps I'm disappointed."
        m "But it's nothing I won't get over."
        mc "I'm sorry."
        m 1e "Don't apologize for this."
        m "It's a small issue, and the more we talk about it the bigger it escalates."
        m 1a "Let's just leave it here, while it's not important."
        mc "If you say so."
    else:
        m 1c "I see."
        mc "You see?"
        m "I see clearly now, [player]."
        m 1d "Your poem style."
        m 1a "It's clearly not meant for me."
        m "At least, not anymore."
        mc "Is it that obvious?"
        m 1e "It is..."
        mc "Monika, I--"
        m 2a "There's no need to explain yourself."
        m "Whether you write your poems in the style of mine or [ch15poemwinner]'s is of no concern to me."
        m 2m "{i}You{/i} control what happens after all."
        mc "I control what happens?"
        "What an odd thing to say."
        mc "It's just...you look upset."
        m 1l "Trust me, I'm hardly upset over this."
        m "So let's just move on, okay?"
        m 1a "No sense making a big deal out of a small issue like this."
        m 1b "In fact, it isn't even an issue."
        mc "Yeah...okay."
    return

label msay_monika_3:
    if monika_type == 0:
        m 2e "You're just continuing to write in my style, aren't you?"
        m "I know it probably doesn't mean much but..."
        m "You should know, I really appreciate that."
        m "Even if the real meaning behind it is gone."
        mc "Real meaning behind it?"
        mc "What do you mean?"
        m 1j "Never mind."
        mc "Well, I'm glad you like what I'm doing."
        mc "I'm really used to your style."
        mc "It's almost not possible for me not to write in an abstract way."
        mc "Even if I chose another style, I think it would still have some of your influence."
        m 1m "Do you think that's a bad thing?"
        m 1n "My influence, that is..."
        mc "N-No! No way."
        mc "I'm glad you're an influence in my life, Monika."
        mc "I'll be honest with you..."
        m 1c "Huh?"
        mc "Talking to you and being around you..."
        mc "It just makes me feel safe."
        mc "And I look forward to our conversations."
        m 1e "You do?"
        m 1j "Well..."
        show monika 1k
        "Monika shows a wide smile."
        m "The feeling is mutual, [player]."
        m 1a "I'm glad to have known you."
        m 2b "To be part of the same club as you."
        m "Ahaha, to think this conversation was only possible because of your poems."
        m 2e "Who knew it would have had such an effect, right?"
        mc "Yeah, it's strange how things just work out."
        m "You have no idea..."
        if persistent.markov_agreed:
            m 2j "It's a shame you made the wrong choice before."
            m "Everything you've done will come back to haunt you."
            mc "What?"
            m 2l "Oh, I was just talking to myself."
        m 2a "But thanks for sharing your poem."
        m "It's always a pleasure."
    elif monika_type == 1 and ch12_markov_agree:
        m 2e "This..."
        mc "Is something wrong?"
        m "Not at all."
        m 2a "In fact, things are as they should be."
        m "This poem is proof of that."
        mc "It is?"
        mc "I'm sorry, Monika but I don't really understand."
        m 4b "You've written almost every poem for me, right?"
        mc "Yeah...?"
        m 4d "In fact, I think it's been every single one."
        m "Ever since you've joined the club."
        m 4a "I could be wrong but it certainly feels that way."
        mc "I don't think you're wrong."
        mc "It's easier for me to write that way."
        mc "Since the first week, an abstract style has just called to me."
        m 4e "I think it's something else."
        m "But whatever it is..."
        m "I want to say thanks."
        mc "Thanks?"
        m 3a "Thanks for helping me get this far."
        m "Thanks for risking everything despite not knowing what's coming."
        m 3b "There are lots of uncertainties ahead of us."
        m 1m "But you're still there."
        m 1n "Still with me."
        mc "I don't think I understand."
        m "A small gesture like this..."
        m "It normally wouldn't mean anything but right now..."
        m "It just means so much to me."
        m 1e "It's just twenty words on a piece of paper and yet..."
        m "My heart beats so fast."
        "Is she even talking to me?"
        m "So, thank you."
        m 2l "Ahaha, sorry..."
        "Monika smiles at me."
        m "I didn't mean to rant."
        mc "It's fine."
        "That message wasn't meant for me...was it?"
    else:
        $ all_sayarc_poems_monika = True
        m 1h "Why are you doing this?"
        m "You have no reason to, you know that."
        m 1i "Are you trying to get a reaction from me?"
        m "Is that what you're doing?"
        mc "...What?"
        mc "I don't understand."
        m "No."
        m 2i "I'm the one that doesn't understand."
        m "There's nothing between us, you know that?"
        if monika_type == 1:
            m 2o "There might have been if..."
            m "No, I can't think about that."
            m 2q "It just gives me a huge feeling of regret."
        elif ch12_markov_agree:
            m 2c "All we are is partners."
            m "Nothing more."
            m "This show of poetry means nothing."
        else:
            m 4h "We are nothing."
            m "We will never be anything."
            m 2i "Am I clear?"
        mc "..."
        "What the hell is she talking about?"
        mc "I don't get it but..."
        mc "I-If you say so..."
        m 2f "There's just one thing I can't comprehend."
        m "I want to get rid of it."
        m "If I don't care about you..."
        m 2g "Why does seeing these poems have this effect on me?"
        m "I can't describe it."
        m 2q "It's like I'm being forced to enjoy it and..."
        m "It's disgusting."
        mc "Right..."
        mc "Well, I'm sorry if I hurt you in anyway, Monika."
        m 1h "Whatever."
        m "Let's get this over with."
        m "If I never see one of your poems again, it'll be too soon."
        mc "I'm sorry it wasn't up to your expectations, Monika."
        "Monika rolls her eyes."
        m 1i "I don't know what I was expecting."
        m "But it's done."
        m 3h "Whatever delusions you have will never come to fruition."
        "She averts her eyes."
        m 1o "I...really need to think about this."
        m "All of this."
        "Maybe she's been having a bad day?"
    return
