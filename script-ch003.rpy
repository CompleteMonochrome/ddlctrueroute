label ch3_main:
    ...
    menu:
        "What should I do?"
        "Approach Monika and ask about Sayori.":
            $ ignore_sayori = False
            $ sayori_save += 1
            pass
    ...
    if monika_appeal[1]:
        m 1e "Oh? I certainly feel a difference."
        m 1j "At least for me."
        m 1e "Though I'm not sure if it's a good thing yet."
        m "Anyway..."
        m "Maybe the reason she's so cheerful around you..."
        m "...is because she's around you?"
    else:
        m 5 "Ehehe."
    ...
    label ch3_activities:
    if n_appeal == 0 and y_appeal == 0 and m_appeal == 0:
        jump ch3_start_none
        ...
        if sayori_save == 3:
            ...
            if ignore_sayori:
                jump ch3_mid_monikab
            else:
                jump ch3_start_monikab
    elif n_appeal > 1:
...
label ch3_start_monika:
    ...
    hide sayori
    "She approaches me, and Sayori wipes her face."
    m "There you are."
    m "I need to talk to you about Sayori."
    mc "Oh, is she okay?"
    m "Can we sit down first?"
    m "This is important, to you and me."
    mc "Sure."
    "I pull up my desk next to her and take a seat."
    play music mend fadeout 1.0
    scene m_cg1_base with dissolve_cg
    # add persistent clear for cg list
    m "You wanted to know if Sayori's feeling okay..."
    m "And..."
    show m_cg1_exp1 at cgfade
    m "Honestly?"
    m "No."
    mc "How can you be so sure?"
    mc "And what's wrong with her?"
    show m_cg1_exp2 at cgfade
    m "I think she's feeling conflicted. She won't open up to me just yet..."
    m "The conversation we just had was probably the best it could have gone..."
    m "Given the circumstances."
    m "But maybe over the weekend, we can fix it..."
    hide m_cg1_exp1
    mc "We?"
    m "I didn't think it would come to this..."
    m "Where {i}I{/i} would be the one to..."
    m "You really have changed me."
    m "You've opened my eyes, [player]."
    m "And..."
    m "Well..."
    show m_cg1_exp1 at cgfade
    m "You can believe me on this one."
    m "I really think we can help her."
    m "As long as everything goes to plan."
    m "Then I can say, with confidence..."
    m "That by the time the festival comes, she'll be feeling a lot better."
    m "Like I said before, she's my friend too."
    m "And I can't help but feel completely responsible for her feeling this way."
    mc "Monika, just because you're the president doesn't mean you're the only one responsible for her."
    mc "As her best friend, I have to take some responsibility for her as well."
    mc "For all we know, I could be the reason she's feeling this way."
    m "That's not..."
    m "{i}(If only you knew...){/i}"
    m "[player], seeing her down like this knowing what I've done..."
    m "It's..."
    m "It's terrible."
    m "I just wish I was a better friend from the beginning."
    mc "Well..."
    mc "I'm glad I have you as a friend Monika."
    mc "From the beginning of my time here, you've been nothing but friendly towards me."
    mc "And I'm not sure if that's just because you're the president or something else."
    mc "But I'm happy to be able to call you a friend."
    hide m_cg1_exp1
    m "Did you just say that I'm your friend?"
    mc "Um...yeah."
    mc "I didn't mean to presume anything but--"
    m "No, that's alright..."
    m "I'm also happy to be able to call you a friend."
    m "This never would have happened, if {i}you{/i} didn't do this."
    show m_cg1_exp1 at cgfade
    mc "I'm sorry if me going to you with Sayori caused you any concern."
    mc "She's just really important to me and I'd hate to see her get hurt."
    hide m_cg1_exp2
    m "Don't apologize, in fact I should be the one to apologize..."
    mc "Eh? What do you have to apologize for?"
    hide m_cg1_exp1
    m "..."
    m "Y-You don't know...do you?"
    m "I mean, how would you?"
    m "You aren't--"
    m "Ah..."
    m "Look, there's no need to be worried about Sayori. I promise."
    show m_cg1_exp1 at cgfade
    show m_cg1_exp2 at cgfade
    m "We can make it right."
    m "Together."
    m "After all you've given me so much."
    mc "I haven't given you much at all, have I?"
    m "I suppose you don't think you have..."
    m "...But it feels different for me."
    "In the time we've spent together, it was all about Sayori and the festival."
    "Unless she's talking about something else?"
    "Is there something new I'm missing?"
    "Still, if whatever Monika's talking about helps Sayori, I'm eager to help."
    "I just hope whatever Monika talked to her about can help fix Sayori's problems."
    "My life just wouldn't be the same without Sayori."
    mc "Maybe I should talk to her, before we start sharing poems."
    hide m_cg1_exp2
    m "I'd give her time to think, she seems to be deep in thought right now."
    mc "You're probably right."
    mc "It's just I've never seen her like this."
    m "..."
    m "Hey, [player]?"
    show m_cg1_exp2 at cgfade
    m "Can you just stay here for a while?"
    m "With the festival coming up and Sayori feeling down..."
    m "I just want to sit down here and think."
    m "Think about the future and what it holds."
    hide m_cg1_exp1
    m "...And well..."
    m "I enjoy your company~"
    mc "..."
    mc "Of course..."
    scene bg club_day
    $ act_one_dialogue[0] = True
    $ act_one_dialogue[1] = False
    jump ch3_start_none
...
label ch3_mid_monikab:
    ...
    show monika 2b zorder 2 at t11
    m "[player]! What's up?"
    mc "Actually, I just wanted to speak with you."
    m 2e "Oh?"
    m "About anything in particular?"
    mc "Um...not really, I just..."
    m 5 "It's okay!"
    m "If you just wanted to speak with me..."
    m "I'm more than happy to chat~"
    m 2h "Hmm..."
    jump ch3_mid_monika_cont
...
label ch3_start_monikab:
    ...
    m "I need to talk to you about Sayori."
    mc "Oh, is she okay?"
    m 1e "Well, I just spoke with her."
    m "I think the conversation we had went pretty well."
    m 1d "I'm not entirely sure what's wrong with her, but it shouldn't be anything too bad."
    mc "I'm a bit worried for her. It just feels bad seeing her like this."
    m 1c "[player], I'll do everything I can to stop those feelings towards her."
    m "Er--"
    m 1l "For the good of Sayori, of course."
    "I know she's trying to help Sayori, but the way she said that just feels wrong."
    "But she's Sayori's friend too, I'm sure she means well."
    m 1c "Anyway, I could tell she's feeling conflicted."
    mc "Do you know what about?"
    m 1f "I've got a faint idea, but I can't be too sure yet."
    m 1a "Maybe after this weekend, we'll all be feeling better."
    m "Don't get too hung up about it, [player]."
    m "Ah, that reminds me."
    m 2a "Sayori and I will be working together this weekend."
    m "Maybe you can help Sayori and I sort out this mess?"
    m 2b "I'm sure she wouldn't mind you being there to help."
    mc "Well, I'm happy to do what I can to help Sayori."
    mc "After all, what are friends for?"
    label ch3_mid_monika_cont:
    show monika 2a zorder 2 at t11
    play music t6 fadeout 1
    m "Well, now that we have this chance to talk..."
    m "I'd like to ask a question, if that's okay with you."
    mc "Is it personal again?"
    m 1l "No, nothing like that..."
    if not ignore_sayori:
        m "Besides, that would probably be inappropriate given the situation."
    mc "Well, ask away then."
    m 1c "What would {i}you{/i} do if you knew the world around you was fake?"
    mc "Well..."
    mc "I'm gonna have to think about this for a little bit."
    mc "Hmm..."
    mc "How would I know it was fake anyway?"
    m 1a "Maybe you felt it, the world started losing it's meaning to you."
    m 1l "This is all hypothetical of course, it's just a question."
    ...
    m 1e "No, not at all!"
    m "After all, I was the one who asked the question."
    ...
    mc "Oh?"
    m "I'd actually take a similar approach to you."
    m 1e "Ah, that is if I was in that same situation."
    m "Trying to find someone real and escape seems impossible though."
    m 1a "I mean, where would you start?"
    m "It's not like you can just make a program and send it out to the people on the outside."
    m "Ahaha..."
    m 1j "It's not like we're in a virtual world though, is it?"
    m 1e "I mean, surely {i}we{/i} would know if we were living in one."
    ...
    m 2a "I guess it is a little abstract."
    m "Maybe that's why I wondered what you thought."
    m "Seeing as you've been writing some abstract poems."
    m "Speaking of which..."
    m 5 "You haven't been writing those for me, have you [player]?"
    "The truth is, I have been writing them for Monika."
    "But she's put me in such a weird spot here."
    "What do I say in a situation like this?"
    mc "Um...well actually..."
    m 1a "Ahaha, it's alright. I understand."
    m "And I want you to know that I really appreciate it."
    "Monika shows a sweet smile."
    m "I'm glad we could become friends, [player]."
    mc "Ah, yeah same."
    mc "I just never really thought it would happen."
    mc "To be honest, I always though you were out of my league."
    mc "With you being so popular and all."
    m 2e "Ah, do I seem that unapproachable?"
    mc "N-No! Not at all, I just didn't think you'd bother to spend time with someone like me."
    mc "In fact..."
    mc "I'm not sure if it's your obligation as president or something else that you're talking with me right now."
    mc "Still, I'm glad we can talk about stuff like this."
    mc "And not just stuff relating to the club itself."
    m 2a "Well, I certainly don't mind your company."
    m 5 "So it's not completely because of my obligation as president~"
    $ act_one_dialogue[0] = False
    $ act_one_dialogue[1] = True
    jump ch3_start_none
...
label ch3_start_none:
    ...
    if ignore_sayori:
        "Maybe I should have got her to talk with Sayori."
        "But Sayori told me to have some fun, and it seemed like she wanted to be alone."
        "Still..."
    else:
        if monika_will_delete:
            "I wonder if Monika's conversation with Sayori went as well as she said."
        elif not monika_will_delete:
            "I sure hope her conversation with Sayori went as well as she said."
        else:
...
label ch3_end:
    ...
    m "Calm down, guys...!"
    if ignore_sayori:
        m 1d "Hmm...maybe I should have spoken with her."
    elif not act_one_dialogue[0]:
        m 1d "I talked to her earlier, and everything is fine."
    else:
        m 1d "She's feeling a little down right now, but I'm sure she'll be fine."
    show monika zorder 2 at t32
    if ignore_sayori:
        mc "I should have told you."
    elif act_one_dialogue[0] or act_one_dialogue[1]:
        mc "It's true, Monika reassured me she's fine."
    else:
        mc "What did she say...?"
    show monika zorder 3 at f32
    show yuri 1e
    ...
    if act_one_dialogue[0]:
        m 1a "I'm sure Sayori would also appreciate your help."
    else:
    ...
    if help_sayori:
        ...
        "My anxiety still shoots through the roof."
        "I think we've become pretty close friends."
        "Besides..."
        "It's not like we feel {i}that{/i} way about each other..."
        "Is it?"
        if act_one_dialogue[0]:
            "She did seem a little upset that I couldn't help her and Sayori."
            "But I'm doing this to help Monika make this an awesome festival."
        elif act_one_dialogue[1]:
            "She did seem a little upset when I had to choose someone else."
        else:
            "[ch4_name] needs all the help she can get."
            "And I don't mind getting to know her as well."
        "I have nothing to worry about."
        "If I just go with it, then I'll have a good time."
    else:
...
label ch3_end_sayori:
    ...
    if act_one_dialogue[0]:
        mc "She doesn't seem to be feeling well and..."
...
label ch3_end_monika:
    ...
    show natsuki zorder 2 at t31
    if act_one_dialogue[0]:
        show monika 1q zorder 3 at f32
        m "For the club?"
        m "Okay...I get it."
    else:
        show monika 1p zorder 3 at f32
...
label ch3_end_natsuki:
    ...
    show monika 1d zorder 2 at t32
