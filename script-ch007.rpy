label ch7_main:
    ...
    if read_book or did_all_tasks:
        ...
        y "And every time you're near me..."
        y "I don't know why..."
        ...
        m "Sayori got 'you' out of there, just in time."
    ...
    s "So I guess she took it upon herself to set the desks out."
    show monika 5 zorder 3 at f42
    show sayori zorder 2 at t43
    m "Ahaha, it does seem kinda planned, doesn't it?"
    m "We should appreciate the work Yuri has done though."
    m "It saves us a lot of time."
