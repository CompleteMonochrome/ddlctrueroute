...
label ch40_main:
    ...
    if persistent.dialogue_change[1]:
        call ch40_clearmonika
    elif persistent.clearall:
        call ch40_clearall
    else:
    ...
    label ch40_clearmonika:
        s "I wanted to thank you for spending so much time with us all."
        play music mend
        s 2d "Even if Monika ruined everything..."
        s "I can't help but feel sorry for her."
        s "She wasn't always like that."
        s 1a "Do you get it, [player]?"
        s "Because I'm President now, I understand everything."
        s 1k "I know that you installed a mod to give Monika a chance."
        s "And I know that she ruined that chance."
        s 1a "You must have already completed the game once before, right?"
        s "And you saved and reloaded so many times, to spend time with everyone!"
        s "I'm so happy that you care about the Literature Club that much."
        s 1u "I'm just sad that Monika couldn't make the most of her chance."
        s 1k "Maybe she could have done things differently, and she could have had a better ending."
        s 1g "But I'm not as good as Monika with these sort of things."
        s "I can't check if there are some things you could have done differently."
        s "Maybe you can start again and help Monika through her problems."
        s "Because now..."
        ...
        s 1y "So..."
        s "This is where we say goodbye."
        s 1d "Thank you for playing the {i}Monika Route Mod{/i}."
        s "I'm going to miss you, [player]."
        s "Come visit sometime, okay?"
        s "We'll always be here for you."
        s 1t "We..."
