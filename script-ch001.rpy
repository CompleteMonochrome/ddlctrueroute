...
label ch1_end_monika:
    ...
    mc "..."
    mc "...Monika!"
    show monika 1m behind yuri at l31
    show yuri zorder 2 at t32
    show natsuki zorder 2 at t33
    m "Me?!"
    mc "...Yeah!"
    mc "You're the president, can't you help me with this?"
    m "Um..."
    show monika zorder 3 at f31
    m 4d "You're right."
    m "Natsuki, Yuri you have to stop this."
    show monika zorder 2 at t31
    show natsuki 4w zorder 3 at f33
    n "I already told you, this has nothing to do with you!"
    show natsuki zorder 2 at t33
    show yuri 2g zorder 3 at f32
    y "I-I agree..."
    y "It's unfair for others to interject their own feelings into our conflict."
    show monika 4g zorder 3 at f31
    show yuri zorder 2 at t32
    m "Actually, as Pres--"
    show monika zorder 2 at t31
    show natsuki zorder 3 at f33
    n 4c "Yeah, unless Monika wants to tell Yuri what a stuck-up jerk she's being."
    show natsuki zorder 2 at t33
    show yuri 3r zorder 3 at f32
    play music t7
    y "She would never...!"
    y "It's your immaturity that caused this in the first place!"
    show yuri zorder 2 at t32
    show natsuki 1e zorder 3 at f33
    n "{i}Excuse{/i} me?"
    n "Are you listening to yourself?"
    ...
    play music t8
    m 1f "Natsuki! Yuri!"
    m "You guys joined this club because of your passion of literature!"
    m 1r "I don't want our friendships to be ruined because of something like this."
    m "You two are both wonderful people."
    m "And I appreciate both of you for your differences."
    m 1g "Natsuki's poems..."
    m "They're amazing because even though the length is short, they give so many feelings."
    m "And Yuri's poems are amazing because they give your imagination beautiful pictures to think of."
    m 4p "Everyone's talented in their own way..."
    m "...So why fight over something that makes us unique?"
    show monika zorder 2 at t31
    show natsuki zorder 3 at f33
    n 1r "Be-Because..."
    show natsuki zorder 2 at t33
    ...
    mc "Sayori..."
    "Sayori stands triumphantly."
    "Monika stands beside her with a bewildered expression."
    show yuri at s43
    y 3q "I'll...make some tea..."
    show yuri behind sayori at lhide
    hide yuri
    ...
    show monika 1i zorder 2 at t11
    hide sayori
    mc "Sayori really knows what to say, doesn't she?"
    "I whisper to Monika."
    "She nods in return."
    m 1e "Ahaha, you're right about that."
    m 1d "She manages to do the things around here that I have trouble with..."
    m "I mean I might come off as a good leader, and I can organize things..."
    m 3e "But I'm not very good with people..."
    m "I couldn't even bring myself to interject."
    m "Until you encouraged me."
    m 1m "As President, that's kind of embarrassing of me."
    m 1l "Ahaha..."
    mc "Nah..."
    mc "It's not like I can blame you."
    mc "I wasn't able to say anything, either."
    m "Well..."
    m 2a "I'm just glad Sayori helped me back there. She is amazing in her own ways, isn't she?"
    mc "You could say that."
    mc "She might be an airhead, but sometimes it's weirdly suspicious that she knows exactly what she's doing."
    m 5 "I see~"
    m "Take good care of her, okay?"
    ...
    menu:
        ...
        "She gets hurt all the time.":
            mc "She does stuff like this all the time."
            mc "It's what makes her get along with others so well."
            mc "Though that's probably why she gets hurt too."
            mc "But I'd hate to change that part of her, it's what makes her who she is."
    "Monika smiles sweetly at me, causing my stomach to knot."
    "Such a genuine person really does make a good President, regardless of what she says."
    "If only I could get the chance to talk to her a little more..."
    return
