label ch4_main:
    ...
    if visited_sayori_sat:
        "It's finally Sunday."
    else:
        "It's already Sunday."
        if act_one_dialogue[0]:
            "I feel really bad I didn't get to visit Sayori yesterday."
            "I really tried but yesterday just seemed to pass by so quickly."
        elif act_one_dialogue[1]:
            "I feel like I was meant to do something yesterday."
            "Every time I try to remember what it was, my mind gets hazy."
        "Anyway..."
    ...
    if visited_sayori_sat:
        "I haven't heard a thing from Sayori since I left her house yesterday."
        "It's not like we text each other all the time or anything..."
        "But I've been worried about her in the back of my mind."
        "Monika seems to bring up that she seems to be the one to blame for this a lot."
        "I wonder if there's any truth to those words..."
    else:
    ...
    with wipeleft_scene
    if visited_sayori_sat:
        "I said I'd visit Sayori again today, so that's what I'm doing."
    else:
    ...
    if visited_sayori_sat:
        ...
        "Sayori tries to avoid eye contact."
        s 1bs "I feel a lot better too!"
        "She's seems so full of color today."
        "Monika must have really talked it out with her last night."
        mc "So you aren't feeling depressed anymore?"
        s 1ba "Actually, before we talk about that, can we step outside?"
        mc "Yeah..."
        scene bg house with wipeleft
        show sayori 1bd zorder 2 at t11
        s "Thank you..."
        s "It just feels a lot more free out here..."
        s "I can feel the air and it doesn't feel like torture."
        mc "How are you feeling, any better?"
        s 1bt "When you're around, I don't feel so bad..."
        s "Ahaha..."
        s "You know..."
        s "I've had depression my whole life."
        s "It got worse...but now..."
        s 1bk "Don't worry about me, the thoughts of ending myself..."
        s "They're gone, it's like I'm free of some burden."
        mc "What about those rainclouds you talked about?"
        s 1bm "The rainclouds?"
        s 1bn "..."
        "Sayori puts her hand out to her ear, as if listening to something."
        s 1br "Ah! Now that you mention it, they're gone too!"
        s 1bt "Thank you so much [player]!"
        show sayori at h11
        "Sayori shows me a big smile and wraps her arms around me."
        "Unlike her smile on Friday, this seems truly genuine."
        mc "Well, I'm glad you're feeling better."
        "I release her embrace quickly, trying not to make it awkward for myself."
        mc "You know you really had me worried there."
        s 4by "Eh? Could it be possible you care about me like {i}that{/i}?"
        mc "S-Sayori!"
        s 1bs "Ehehe~"
        mc "And anyway, it wasn't just me."
        mc "Monika helped you as well."
        s 1bb "Hmm..."
        s "Monika talked about some weird things yesterday..."
        s "Like about her role in the Literature Club and how she felt responsible for me..."
        s "But she really did help me get through it all."
        s 1bq "I'm really lucky to have her as a friend!"
        mc "Yeah, you're not wrong there."
        "Seeing Sayori like this gives me energy."
        "It's like she's radiating it or something."
        mc "Speaking of which, where is she?"
        s 1bb "She went home after we got most of the work done."
        s "Or at least, that's what she told me."
        s "I haven't really seen or heard from her since then."
        s 4br "But I'd like to find her, so I can say thanks~"
        s 1bq "I'm so ready for the festival tomorrow!"
        "Her enthusiasm was getting to me, it was a little too much to handle."
        "But it's better than seeing her down."
        mc "Me too!"
        s 1bj "No you aren't!"
        mc "Huh?"
        s "You still have to do your thing with [ch4_name]!"
        mc "Oh, right."
        mc "Wait...you know about that?"
        s 1bd "Of course I do! Monika told me about the club's activities while she was here."
        mc "I guess that makes sense."
        mc "Speaking of which, I think it's almost time for her to come over."
        s 1bh "Aw, really?"
        s "That's too bad..."
        s 1by "It would have been nice if you could have helped me finish these pamphlets off."
        mc "I'm sure you can manage Sayori."
        "For the first time in a while, I can sense Sayori is feeling okay."
        "There's nothing for me to worry about."
        s 4bx "Well, I'll see you at the festival tomorrow right?"
        mc "Of course, I can't wait."
        s 4bt "There's one more thing."
        play music t10 fadeout 2.0
        "Sayori looks away."
        "Suddenly, it feels like all her enthusiasm just disappeared."
        "I put a hand on her shoulder to reassure her."
        s "I have something to say, [player]..."
        s "And I'm not sure if it's the time..."
        s 1be "But ever since I've been feeling better, I feel like I need to get it out."
        mc "What is it?"
        s "I think I like you."
        mc "Eh? I know that you dummy, otherwise we wouldn't be best friends!"
        s 1bk "Not like that..."
        s 1by "I mean..."
        s "You know..."
        mc "Sayori, what are you talking about?"
        s 1bl "You're going to make me say it, aren't you?"
        s 4bl "Here goes..."
        s 4bs "I love you [player]."
        "Is this what Monika was talking about?"
        "Sayori found the courage to confess to me?"
        mc "Sayori...?"
        s "I have for a while now and..."
        s "I didn't want to tell you before because I didn't want you to care about me."
        s 4bd "But I feel different now, like everything is looking up."
        s "So I need to tell you how I feel."
        s "And..."
        "Sayori takes a deep breath before collecting her thoughts."
        s 1be "I need to know if you feel the same."
        mc "Sayori..."
        mc "I didn't know, I should have realized."
        mc "I want to get rid of your depression and those rainclouds forever."
        ...
        "With that I leave Sayori to her cleaning."
        if sayori_confess:
            "I know I'm going to have a happy future with her."
            "Or I'm going to try my best to."
            "On the way home, I find myself feeling better about Sayori."
            "I'm going to help get rid of the last of her bad feelings, by her side."
        else:
            "She seems to have a newfound determination, though I wonder how long that will last..."
            "On the way home, I find myself feeling better about Sayori."
            "She doesn't have so many thoughts that could lead to her death anymore."
            "And with a little help, I can help get rid of the last of those bad feelings."
            "As her friend."
        "There's still something else on my mind though."
        "The past couple of days, Monika seemed to be blaming herself for Sayori."
        "Sayori's feeling better now though, so maybe Monika is too?"
        "Anyway I should get home, [ch4_name] is probably waiting for me already."
    else:
        "Sayori isn't anywhere on the first floor, so I assume she's up in her room."
...
label ch4_exclusive_natsuki:
    ...
    if visited_sayori_sat:
        "I'm already getting texts from Natsuki asking me to open the front door."
        "She doesn't know I'm not home so she's in for a surprise."
        "Especially with how she is."
        show natsuki 2bj zorder 2 at t11
        mc "Ah, sorry I'm late."
        mc "I had to take care of something, were you waiting long?"
        n 2bk "No, I just got here a few minutes ago."
    else:
    ...
    if visited_sayori_sat:
        ...
        show monika 1bm zorder 3 at f21
        m "Ah, I didn't mean to interrupt."
        m "Hello [player]."
        mc "Monika--!"
        mc "Just now, we weren't--"
        m 1bj "Ah..."
        m "It's alright, [player]."
        m 1be "I just came by to let you know something."
        ...
        m 1bf "There's really no need for you to leave."
        m "I'll just be here briefly."
        show monika zorder 2 at t21
        show natsuki zorder 3 at f22
        n 2bq "Yeah, well..."
...
label ch4_end:
    if visited_sayori_sat:
        ...
        mc "Monika--"
        mc "I wasn't expecting to see you here today!"
        m 2be "This isn't what you think it is."
        m 2bg "In fact, it's a goodbye."
        mc "Is this what you were talking about yesterday?"
        mc "You were going to say goodbye?!"
        "She nods and smiles meaningfully."
        m 2bq "..."
        m 2bl "Well Sayori is feeling a lot better, right?"
        m "And..."
        m 2bo "I shouldn't stay here if it's going to stay that way."
        "She's still blaming herself for Sayori's depression?"
        "But she's feeling better now, so why is Monika still..."
        mc "You're welcome to stay here if you need to."
        mc "After all you've helped me save Sayori's life."
        m 1bq "That's kind of you to offer."
        m "But no."
        m "The rainclouds will come back if I don't leave, and I just want you to be happy."
        m 1ba "After all..."
        m 1bb "{i}You{/i} gave me a chance."
        m "A chance I never would have had."
        m 1be "A chance..."
        m "...that I ruined."
        m "I thought maybe I didn't..."
        m 1bg "That I could simply reverse what I did to her."
        m "But what she's feeling is more complex than I thought."
        m "You can't simply just get someone out of depression, you know?"
        m "Even with what I can do..."
        m 1be "So that's why..."
        m "...I have to fix what I started."
        m "And the only way to do it for sure is by deleting myself."
        mc "..."
        mc "What are you saying?!"
        show monika 1bg zorder 2 at t11
        if sayori_confess:
            mc "You're my friend and over the past week I'm glad we've had a chance to get closer."
        else:
            mc "You're my friend and over the past week you've become really important to me."
        mc "I'm not sure about your problems, but I don't want to see any of my friends in pain."
        mc "So like Sayori, I'm going to do whatever it takes to help you."
        show monika 1bp zorder 2 at t11
        "She's clearly taken aback by my words."
        "There's a brief moment of doubt in her eyes before she starts to talk again."
        m 1bf "It's a nice sentiment."
        m "But like I said, I just came here to say goodbye."
        m 1bn "I just have one last request."
        mc "Name it."
        m 2be "Promise me you'll enjoy the festival tomorrow..."
        m "...For me~"
        m "Okay?"
        mc "But..."
        mc "There must be something I can do to change your mind."
        m 1bh "Well...maybe not you in particular but..."
        "She stops herself from finishing that sentence."
        m 1be "Ah, no. I've made up my mind, can't go changing it now."
        m "Ahaha..."
        m "..."
        m 1bp "Just..."
        m "...Remember me, okay?"
        m "Are you listening?"
        m 1be "I'm not talking to that 'you' in the game anymore."
        m 1bm "I'm talking to the real {i}you{/i}, [player]."
        ...
        if not list(set(process_list).intersection(stream_list)):
            if currentuser != "" and currentuser.lower() != player.lower():
                m "Or..."
                m "...[currentuser], whatever you want to call yourself."

        m 1bp "Thinking back on it...I never really got to know the real you."
        m 1bn "Well, never mind."
        m "There's no point reflecting on that now."
        m "I'm leaving, so that you can be happy."
        if sayori_confess:
            m "I'm glad you and Sayori ended up together."
            m 1be "I just want {i}you{/i} to know that I still love you."
        else:
            m "I helped Sayori because she was your friend."
            m "So that you could be together..."
            m "But it seems--"
            m 1bm "Ah, if only I didn't mess up."
            m "The two of us might have had a chance."
            m 1be "I just want {i}you{/i} to know that I love you."
        m "With all my heart..."
        if sayori_confess:
            m "Even if the 'you' in game chose someone else."
        m "You were the light I needed to see..."
        m "In this game..."
        m 1bf "And maybe those words don't mean much to you."
        m 1bm "But they're true...so..."
        m "Before I disappear forever. Just try not to remember me as..."
        m "The selfish president."
        m 1bj "But just the good things about me, okay?"
        m "Just..."
        m 1be "...Just Monika."
        m 1bl "All the poems I wrote..."
        m "They were all about my realization of this world."
        m "How I knew that you were the only real person in it."
        m "But...my last poem."
        m "The one about that Lady."
        m "It's about me."
        m 1bq "And the terrible things I did to Sayori..."
        m "Did you notice that?"
        m "It was full of regret..."
        m "And this must just be my retribution."
        m "..."
        m 1be "You know, our little talks..."
        m "...They made me think hard about who I am."
        m "But I don't have much time left so I'll finish up, okay?"
        m 1ba "You are the most wonderful thing that's ever happened to me."
        m "Thank you for trying to help me..."
        m 1be "For letting me try..."
        m "The others..."
        m 1bm "They deserve better than me."
        m "I haven't been the best president the club could have had."
        m 1bk "That's all I have to say."
        m "Thanks for listening~"
        "As Monika starts to walk away, I try to reach out."
        "But my body won't move."
        show monika at lhide
        hide monika
        "Monika looks back at me and I catch a glimpse of a sad smile before she walks off."
        mc "...!"
        "Why can't I say anything?"
        "I can't even act."
        "What is this feeling?"
        "There has to have been something more I could have done."
        "But I'm having more trouble understanding Monika than Sayori."
        "I want to reassure her..."
        "Get her to stay..."
        "What if I did something different?"
        scene black with wipeleft
        "..."
        "I'll fulfill your last request Monika."
        "And enjoy the festival, like you wanted."
        ...
        s 2bl "Ahaha, well..."
        if act_one_dialogue[0]:
            s "Monika convinced me to come see you..."
            s "And I was a little curious..."
        else:
        ...
        if act_one_dialogue[0]:
            s 1bv "She tried talking to me..."
            s "She tried all sorts of things..."
            mc "Monika...?"
            mc "She must not have got through to you..."
            mc "I'm sorry, I should have visited you yesterday."
            mc "I don't know what happened, it just seemed to pass by so quickly."
        else:
...
label ch4_end_yes:
    ...
    if act_one_dialogue[0]:
        mc "And please, stay with Monika."
        mc "She's trying to help you Sayori."
        mc "So trust me when I say she only wants the best for you."
        s "..."
    ...
    if act_one_dialogue[0]:
        "I just hope Monika can help her."
...
label ch4_end_no:
    ...
    if act_one_dialogue[0]:
        "I hope Monika is doing okay with Sayori..."
        "I should have visited yesterday..."
    "But I'm having as much trouble understanding Sayori's feelings as she is."
    "Even though I can comfort her..."
    "I keep wondering if I should be doing something more, or something different."
    "I know these thoughts will continue to plague me until things are back to the way they were."
...
label ch4_mid_yes:
    mc "I love you."
    s 1bl "I knew you didn't--"
    s 1bm "What?!"
    mc "Those are my true feelings."
    mc "So...I guess I like you a lot too."
    mc "I should have realized it sooner."
    mc "But spending time with everyone at the club..."
    mc "Making new friends..."
    mc "And having fun with you every day..."
    ...
    mc "Me too."
    s "..."
    "I feel Sayori's grip around me tighten a little bit."
    s "What is this...?"
    mc "Sayori...?"
    s "These are..."
    s "Happy tears."
    s "First, all the rainclouds left..."
    s "And now..."
    s "I..."
    mc "It's okay, Sayori..."
    mc "There's no need to say it, I know."
    mc "You're here with me and that's all that matters right now."
    s "[player]..."
    scene bg house
    show sayori 1bv zorder 2 at i11
    with dissolve_cg
    ...
    mc "We'll go at whatever pace suits you best."
    s 1bd "Hey, [player]..."
    "Sayori gazes at me once again."
    s 4bd "Even if I get really, really sad again..."
    s "This is the best thing for me...right?"
    mc "Eh...?"
    "I don't really understand what Sayori means by that."
    s 1bk "I was expecting pain when you told me you loved me..."
    s "Right now, I don't know what I feel...if you accepting my confession will help me..."
    s 4bd "But that's why I want to trust you."
    s "You know what's best for me..."
    mc "...Yeah."
    mc "I do."
    ...
    "But I'm having as much trouble understanding Sayori's feelings as she is."
    "Even though I can comfort her..."
    "And her depression seems to be going away..."
    "I keep wondering if I should be doing something more, or something different."
    "I know these thoughts will continue to plague me until things are back to the way they were."
    "Is that what Sayori meant by not wanting anything to change?"
    "I don't know."
...
label ch4_mid_no:
    ...
    mc "Sayori--"
    s "It's okay."
    s "I'm not going to torture myself for this."
    s "I won't blame the world..."
    s "For me being so selfish..."
    s "So please..."
    s "Please don't worry about these stupid feelings."
    s "I know you're right."
    s "I knew this whole time that there's no happiness down that path."
    s "I'm just glad you came here..."
    s "Just so I could get the answer I needed to hear."
    s "And the other thing..."
    s "You're also right that I just want it to go back to the way it was."
    s "I realize that now."
    ...
    "Sayori's smile finally breaks."
    s "Don't worry."
    s 1bt "It might seem like I'm really sad..."
    s "And I am..."
    s 1bk "But being with you...even if we aren't together."
    s "It makes me feel better."
    s "So that's why..."
    s 1ba "I'll try to be content if things go back to how they were."
    "I'm a little shocked and I just don't know how to react."
    "I wasn't expecting such a reasonable response from her."
    show sayori 4bt zorder 2 at t11
    s "I still have work to do..."
    show sayori at lhide
    hide sayori
    "Sayori looks over her shoulder and flashes me one more weak smile before turning around and running off back to her house."
    mc "Sayori!"
    "..."
    "Her response just seemed so unlike her."
    "Maybe she has changed for the better."
    "But did I do the right thing?"
    "I shouldn't feel so bad..."
    "The most I can do is support Sayori through her feelings and help her on the path that's right."
    "But I'm having as much trouble understanding Sayori's feelings as she is."
    "The truth is, I just don't feel that way about her."
    "But I'm going to help her find another reason to smile."
    "I'm going to give it everything I've got."
    "Sayori will always be my dearest friend."
    "And I'll do whatever it takes to put a smile on her face every day."
    return
